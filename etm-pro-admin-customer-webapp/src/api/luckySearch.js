 ...
 */
export function createSendMessage ({ resultCustomerAddressIdList, type, content }) {
  return request({
    url: '/customer/customer_contact/do_send',
    method: 'post',
    data: { resultCustomerAddressIdList, type, content }
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function callUp ({ resultCustomerAddressId, type, demo }) {
  return request({
    url: '/customer/customer_contact/do_call',
    method: 'post',
    data: { resultCustomerAddressId, type, demo }
  })
}
