 ...
 * @returns {AxiosPromise}
 */
export function queryHistory ({ batchId, portrait, status, gender, portraitLevel, pageNum, pageSize, paged, sort }) {
  return request({
    url: '/customer/customer_portrait/history',
    method: 'get',
    params: { batchId, portrait, status, gender, portraitLevel, pageNum, pageSize, paged, sort }
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function queryPortraitTotal () {
  return request({
    url: '/customer/customer_portrait_batch/history/list/statistics',
    method: 'get'
 ...
 * @returns {AxiosPromise}
 */
export function createConsumePoint ({ doTouchTotal, batchId }) {
  return request({
    url: '/customer/customer_contact/pay_point',
    method: 'post',
 ...
 * @returns {AxiosPromise}
 */
export function queryWaitCustomTotal () {
  return request({
    url: '/customer/customer_portrait_batch/statistical',
    method: 'get'
...
/**
 * 根据画像历史批次id获取画像标签
 * @param batchId 画像历史批次id
 * @returns {AxiosPromise}
 */
export function queryPortrayalTags (batchId) {
  return request({
    url: '/customer/customer_portrait_batch/history/batch/query_condition',
    method: 'get',
    params: { batchId }
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function removePortrait (batchId) {
  return request({
    url: `/customer/customer_portrait_batch/history/batch/${batchId}`,
    method: 'delete'
