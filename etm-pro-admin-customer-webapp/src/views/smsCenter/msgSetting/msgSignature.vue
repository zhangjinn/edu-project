<template>
  <div class="msgSignature-wrap">
    ...
    >
      ...
      >
        <etm-upload-img
          :resource-name="'customer/costList'"
...
import { getImgUrlRelativePath } from '@/utils'
import { createSignature, querySignature, updateSignature } from '@/api/smsCenter'
...
export default {
  ...
  methods: {
    ...
    init () {
      // const smsType = 'NOTICE'
      const crmId = localStorage.getItem('currentOrganizationId')
      querySignature({ organizationId: crmId }).then(res => {
