    ...
    <etm-main-body>
          ...
          <div class="tree">
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  @click.prevent="handleOrgTreeNode(node, data)"
                >
                  <i
                    v-if="data.type === 'ENTERPRISE'"
                    class="iconfont icongongsi"
                  />
                  <i
                    v-else
                    class="iconfont iconzuzhijiagou"
                  />
            ...
            >
              <span
                ...
                slot-scope="{ node, data }"
                class="custom-tree-node"
                :class="{active: tab === 2 && currentClassNameId === data.name + data.id}"
        ...
        >
          ...
          >
            ...
            >
              ...
              <el-button
                slot="right"
                v-has="{authId: 'basic.employee.create'}"
                type="primary"
                @click="addEmployee"
              >
                <i
            ...
            >
              <template v-slot="{row}">
                <etm-text
                  type="primary"
                  @click="employeeDetail(row)"
                >
                  详情
                </etm-text>
                <etm-text
                  v-has="{authId: 'basic.employee.update'}"
                  type="primary"
      ...
      >
        ...
        >
          <el-form-item label="企业LOGO">
            <el-avatar
              v-if="orgDetailData.avatar"
              class="etm-avatar"
              :size="40"
              :src="orgDetailData.avatar"
            />
            <span
              v-else
              style="display:flex; align-items: center; width:40px; height: 40px;"
            >
              <i
                style="font-size: 40px; color: #C1C4CC;"
                class="iconfont icondangqianqiye"
              />
            </span>
          </el-form-item>
      ...
      >
        ...
        >
          ...
          >
            <etm-address
              v-if="orgVisibleCreate"
              v-model="orgDetailData.areaCode"
              :area-id="orgDetailData.areaCode"
            />
          </el-form-item>
          <el-form-item
            label="详细地址"
          ...
          >
            <el-input
              v-model="orgDetailData.principalName"
              placeholder="请输入负责人"
            />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input
              v-model="orgDetailData.principalTelephone"
              placeholder="请输入手机号码"
            />
          </el-form-item>
          <el-form-item
      ...
      >
        ...
        >
          ...
          <el-form-item
            v-if="depDetailData.tagList && depDetailData.tagList.length>0"
            label="业务标签:"
          >
            <!--TODO: <span>{{ depDetailData.tagList.map(item => item).join(',') }}</span>-->

            <span
              v-for="(tag, index) of depDetailData.tagList"
              :key="index"
            >{{ tag.name }}</span>
          </el-form-item>
        </etm-form>
      ...
      >
        ...
        >
          ...
          <el-form-item label="上级部门">
            <el-input
              v-if="depStatus === 'create'"
              v-model="parentDep.name "
              disabled
            />
            <el-input
              v-else
              v-model="depDetailData.parentName "
              disabled
            />
          </el-form-item>
          <el-form-item label="部门名称">
            <el-input
              v-model="depDetailData.name"
              placeholder="请输入部门名称"
            />
          </el-form-item>
      ...
      >
        ...
        >
          <el-form-item label="任职企业">
            <el-input
              v-model="parentEnterprise.name"
              disabled
              aria-placeholder="应用企业"
            />
          </el-form-item>
          <el-form-item
            label="手机号码"
          ...
          >
            <el-input
              v-model="employeeDetailData.name"
              placeholder="请输入昵称"
            />
          </el-form-item>
          <el-form-item
      ...
      <etm-drawer
        :before-close="() => { employeeVisible = false}"
...
export default {
  name: 'Index',
  components: { EtmMainBody, EtmAddress, AddRole, EtmPop, EtmUploadAvatar },
  filters: {},
  mixins: [baseMixin],
  props: {},
  data () {
  ...
  methods: {
    init () {
      ...
      queryOrganizationTree().then(res => {
        ...
        // 默认选中第一个
        const node = { data: { type: 'ENTERPRISE', ...res.data.root } }
    ...
    handlePositionTreeNode (node, data) {
      ...
      this.currentClassNameId = data.name + data.id
      const { id, name } = data
