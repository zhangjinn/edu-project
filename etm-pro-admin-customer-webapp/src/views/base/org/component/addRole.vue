  ...
  <div class="addRole-wrap">
    <div class="container">
      ...
      >
        ...
        <el-form-item
          label="数据权限"
          prop="dataPrivilegeType"
        >
          <el-radio-group v-model="roleData.dataPrivilegeType">
            <el-radio label="ONLY_ME">
              仅本人
            </el-radio>
            <el-radio label="DEPARTMENT">
              本部门
            </el-radio>
            <el-radio label="DEPARTMENT_AND_BELOW">
              本部门及以下部门
            </el-radio>
      ...
      >
        ...
        >
          <div class="tabs-box">
            <div class="pc-box">
              <div class="title">
                <i class="iconfont iconbijiben" />电脑端
              </div>
              <el-tree
            ...
            <div class="mobile-box">
              <div class="title">
                <i class="iconfont iconshoujiduan" />手机端
              </div>
              <el-tree
...
<script>
import { getCurrentAccountSolutionList } from '@/api/employee'
...
export default {
  ...
  methods: {
     ...
     */
    checkTreeNode ([data, node], resource, ref) {
    ...
    init () {
      ...
      getCurrentAccountSolutionList().then(res => {
