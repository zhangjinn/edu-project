          ...
          <div class="scrollBox">
            <div v-for="(item,index) in list" :key="index" class="member">
              <div class="avatar">
                ...
                <div v-else class="noImg textCenter">{{ subName(item.childName) }}</div>
              </div>
          ...
          <van-cell required>
            ...
            <div ref="symptomBox" class="symptomBox">
              <span
                ...
                ref="symptomItem"
                class="symptomItem"
                :class="formData.symptomResult.includes(item.checkProjectName) ? 'selected' : ''"
                @click="choose(item.checkProjectName)"
              >
