          ...
          <div class="scrollBox">
            <div v-for="(item,index) in list" :key="index" class="member">
              <div class="avatar">
                ...
                <div v-else class="noImg textCenter">{{ subName(item.name) }}</div>
              </div>
          ...
          <van-cell>
            ...
            <div ref="symptomBox" class="symptomBox">
              <span
                ...
                ref="symptomItem"
                class="symptomItem"
                :class="formData.symptomResult.includes(item.checkSettingsId) ? 'selected' : ''"
                @click="choose(item.checkSettingsId)"
              >
                {{ item.checkSettingsName }}
              </span>
            </div>
          </van-cell>
        </div>
...
// import { getCheckProject } from '@/service/guardcare/check'
...
export default {
  ...
  methods: {
    ...
    setData() {
      ...
      //   this.formData.symptomResult = data.symptom
    ...
    choose(item) {
      ...
      // console.log(this.formData.symptomResult)
    },
    onCancel() {
      this.$emit('cancel')
    },
