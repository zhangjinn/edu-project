            ...
            <van-row :class="monthData.length > 4 ? 'rowBox' : 'less'">
              <template v-if="!onlyOne">
                <van-col
                  ...
                  :span="12"
                >
                  <div class="circleBox" @click="toMonthDetail(item.courseId + '-' + item.clazzId)">
                    <div class="innerBox">
                      <van-circle
                    ...
                    <p class="text">{{ item.courseName + ' ' + item.clazzName }}</p>
                  </div>
                </van-col>
              </template>
              <template v-else>
                ...
                >
                  <div class="circleBox" @click="toMonthDetail(item.courseId + '-' + item.clazzId)">
                    ...
                    <div class="clazzName">{{ item.courseName + ' ' + item.clazzName }}</div>
                  </div>
                </van-col>
              </template>
            </van-row>
