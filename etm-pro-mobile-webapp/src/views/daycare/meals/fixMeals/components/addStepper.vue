...
export default {
  ...
  watch: {
    clazzInfoData() {
      this.stuMealsCount = this.clazzInfoData.childNormalMealAmount
      this.specialMealsCount = this.clazzInfoData.childSpecMealAmount
      this.employeeMealsCount = this.clazzInfoData.employeeMealAmount
      this.remarks = this.clazzInfoData.remark
    }
  },
  created() {
  },
