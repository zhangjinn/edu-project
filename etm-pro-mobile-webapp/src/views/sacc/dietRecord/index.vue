...
import { getMealRecordList } from '../../../service/sacc/dietRecord'
    ...
    refreshData() {
      ...
      getMealRecordList({
        ...
        data.forEach(v => {
          ...
          if (v.lastTime) {
            const time = transferDate(v.lastTime)
            const gaptime = transferDate().gap(Date.now() - v.lastTime)
