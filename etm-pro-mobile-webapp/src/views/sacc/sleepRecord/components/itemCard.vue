        ...
        <div class="rightWrap">
          <div class="content">
            <p>
              ...
              <span v-if="baby.state === 'SLEEPING'">睡眠中</span>
            </p>
...
import { endSleep, startSleep, getEnumByName } from '../../../../service/sacc/sleepRecord'
        ...
        Dialog.confirm({
          ...
          .then(() => {
            ...
            startSleep({ customerId, startTime }).then(res => {
              ...
              const { customerId, name, age, avatar } = this.listData[0]
              this.$router.replace({
                path: 'sleepDetail',
                query: {
                  customerId,
