    ...
    <etm-main-body>
      <EtmLayoutSplit>
        <div slot="left" class="leftBox">
          ...
          <div class="tips">{{ $t('systemSetting.phonePicture') }}</div>
          <div class="img">
            <img src="../../../assets/images/systemSetting/phonePicture.png">
          </div>
        </div>
        <div slot="right" class="rightBox">
          ...
          <div class="container">
            <div class="stepTitle">
              ...
              <span class="text">{{ $t('systemSetting.wechatPublicSetting') }}</span>
              <span class="iconBox">
            ...
            <div class="stepList">
              <div class="steps">
                <div class="step">
                  <span>01.{{ $t('systemSetting.stepsOne') }}</span>
                </div>
            ...
            <div class="previewCode">
              <div class="previewTitle">
                ...
                <span class="text">
                  ...
                  <div class="subtitle">{{ $t('systemSetting.previewEffect') }}</div>
                </span>
              </div>
              <div class="codeBox">
                <div class="code">
                  <div class="img">
                    <vue-qr v-if="weChatUrl" :logo-src="orgLogo" :margin="10" :size="150" :text="weChatUrl" />
                  </div>
                </div>
