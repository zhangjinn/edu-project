<template>
  <div class="earlySet">
    <etm-form ref="form" type="dialog" :model="formData" :rules="rules">
      <el-form-item :rules="formValidate.nullValueRule(true, '请输入套餐名称', ['change'])" label="套餐名称" prop="caeCoursePackageName">
        <el-input v-model="formData.caeCoursePackageName" v-in-focus placeholder="请输入套餐名称" />
      </el-form-item>
    </etm-form>

    <div>
      <etm-title :border="false" :show-line="true">套餐内容</etm-title>

      <div class="buttonGroup">
        <el-button
          v-for="attr in ['item', 'feeCare']"
          :key="attr"
          type="dashed"
    ...
    <etm-form ref="form2" type="dialog" :model="formData" :rules="rules">
      <el-form-item label="锁定签约数量">
        <div>
          <el-switch v-model="formData.modify" />
        </div>
      </el-form-item>
      <!--      <el-form-item label="托育天数总计">-->
      <!--        {{ formData.lessonTotal }}-->
      <!--      </el-form-item>-->
      <!--      <el-form-item label="购买天数总计">-->
      <!--        {{ formData.buyLessonTotal }}-->
      <!--      </el-form-item>-->
      <!--      <el-form-item label="赠送天数总计">-->
      ...
      <el-form-item label="套餐简介">
        <el-input v-model="formData.introduction" type="textarea" placeholder="请输入套餐详细介绍" />
      </el-form-item>
