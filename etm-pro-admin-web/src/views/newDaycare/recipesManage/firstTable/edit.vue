  ...
  <etm-main-body>
    <etm-layout-split>
      <template slot="left">
        <div class="recipe-collapse">
          <el-input v-model="dishesName" placeholder="请输入搜索内容" @blur="handleSearch">
          ...
          <el-collapse v-if="recipeLists.length>0" v-model="activeNames">
            <div v-for="(it, index) in recipeLists" :key="index">
              <el-collapse-item
      ...
      <template slot="right">
        <EtmWeeklyCalendar ref="xlsxTable" :table-data="tableData" :date="startDate" :week-tag="false" :title-time="false" @handleAdd="handleAdd" @handleUpDate="upDate">

          <template slot="toolLeft">
            <div class="tooLeft">
              <p v-if="weekName">{{ weekName }} </p>
              <p v-if="generationName">{{ generationName }} </p>
          ...
          <template slot="toolRight">
            ...
            <el-button slot="right" type="primary" @click="handleEcommendRecipe">使用推荐食谱</el-button>
            <el-button slot="right" plain @click="handleCopy">复制周食谱</el-button>
            <!--            <el-button slot="right" type="primary">导出Excel</el-button>-->
            <el-button slot="right" plain @click="exportTable">
              导出Excel
            </el-button>
          </template>
    ...
    >
      <div class="popContent">
        <chooseDishes v-if="popVisibleEdit && popType==='choose'" ref="childChooseDishesPopForm" />
        <copy v-if="popVisibleEdit && popType==='copy'" ref="childCopyPopForm" />
      </div>
    </etm-pop>
