  ...
  <div class="main-wrap">
    <etm-layout-split>
      <template slot="header">
        <etm-tabs ref="tabs" v-model="activeName" :setting="hasAuthOfBool('daycare.recipes.setting')" @setting="setting" @tab-click="tabChange">
          <el-tab-pane
            v-if="hasAuth(
...
export default {
  ...
  methods: {
    setting() {
      this.$router.push({ path: '/newdaycare_recipes/recipeSetting' })
    },
    toggle(val) {
      this.show = val
    },
