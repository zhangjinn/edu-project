      ...
      <etm-layout-split>
        <div slot="header">
          <etm-tabs v-model="activeName">
            <el-tab-pane label="幼儿退费" name="refund">
        ...
        <div slot="body">
          ...
          >
            ...
            <el-table-column slot="left" fixed="left" label="所属年级" width="150" prop="gradeName" />
            <el-table-column slot="left" fixed="left" label="班级" width="150" prop="clazzName" />
            <el-table-column slot="left" fixed="left" label="幼儿姓名" width="120" prop="childName" />
            <el-table-column slot="right" label="退费项目" min-width="150" prop="originName" />
            <el-table-column slot="right" label="已收金额（元）" min-width="180" prop="remainingAmount" align="right">
              <template slot-scope="scoped">
    ...
    >
      <etm-layout-split>
        ...
        <etm-form type="dialog">
          ...
          <etm-field-label type="left" label="已收金额（元）">{{ formatMoney(refundData.remainingAmount) }}</etm-field-label>
          <etm-field-label type="left" label="结算可退金额（元）">{{ formatMoney(refundData.actualSettlementAmount) }}</etm-field-label>
          <template v-if="rowData.status === 'IN_PROGRESS'">
            <etm-field-label type="left" label="退费金额（元）">{{ formatMoney(refundData.refundAmount) }}</etm-field-label>
