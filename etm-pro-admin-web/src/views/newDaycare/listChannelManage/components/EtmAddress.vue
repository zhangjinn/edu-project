<template>
  <div class="etm-address">
    <el-select v-model="province" :disabled="disabled" placeholder="请选择省份" @change="provinceChange">
      <el-option v-for="(item, index) of provinces" :key="index" v-bind="{...item}" />
    </el-select>
    <template v-if="showCity">
      <el-select v-model="city" :disabled="disabled" placeholder="请选择城市" @change="cityChange">
        <el-option v-for="(item, index) of citys" :key="index" v-bind="{...item}" />
      </el-select>
    </template>
