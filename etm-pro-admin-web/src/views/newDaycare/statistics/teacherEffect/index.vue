      ...
      colOption: [
        {
          ...
          label: '排课节数', prop: 'courseManagementAmount'
        }, {
          label: '学员约课次数', prop: 'formalChildAppointmentTimes'
        }, {
          label: '学员约课课时', prop: 'formalChildAppointmentLesson'
        }, {
          label: '学员签到次数', prop: 'formalChildAttendTimes'
        }, {
          label: '学员消课课时', prop: 'formalChildConsumeCourseLesson'
        }, {
          label: '试听约课次数', prop: 'expChildAppointmentTimes'
        }, {
          label: '试听签到次数', prop: 'expChildAttendTimes'
        }, {
          label: '试听签单数', prop: 'expChildContractNum'
        }, {
          label: '签单率', prop: 'expChildSignRate', formatter: (row, column, val, index) => {
