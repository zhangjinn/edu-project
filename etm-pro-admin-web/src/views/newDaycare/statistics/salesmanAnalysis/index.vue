      ...
      colOption: [
        {
          ...
          label: '新签约数（个）', prop: 'numberOfNewContracts'
        }, {
          label: '新签约金额（元）', prop: 'newContractAmount', align: 'right'
        }, {
          label: '续签数（个）', prop: 'numberOfRenewals'
        }, {
          label: '续约金额（元）', prop: 'renewalAmount', align: 'right'
        }, {
          label: '购买课时', prop: 'purchaseHours'
        }, {
          label: '赠送课时', prop: 'freeClassHours'
        }, {
          label: '退费数（个）', prop: 'numberOfRefunds'
        }, {
          label: '退费金额（元）', prop: 'refundAmount', align: 'right'
        }, {
          label: '退费课时', prop: 'refundOfClassHours'
        }, {
          label: '电话呼出次数', prop: 'numberOfOutgoingCalls'
        }, {
          label: '电话呼出时长', prop: 'outgoingCallTime', formatter(row) {
          ...
          label: '短信条数', prop: 'numberOfSMS'
        }, {
          label: '总金额（元）', prop: 'totalAmount', align: 'right'
        }
      ]
    }
  },
