      ...
      colOption: [
        {
          ...
          label: '开课节数', prop: 'courseManagementAmount'
        }, {
          label: '试听学员数', prop: 'expChildNum'
        }, {
          label: '正式学员数', prop: 'formalChildNum'
        }, {
          label: '正式学员实到人次', prop: 'actualAttendFormTimes'
        }, {
          label: '预约试听人次', prop: 'reservationExpTimes'
        }, {
          label: '试听实到人次', prop: 'actualAttendExpTimes'
        }
      ]
    }
  },
