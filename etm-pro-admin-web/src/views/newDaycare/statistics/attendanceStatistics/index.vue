      ...
      <etm-layout-split>
        <div slot="header">
          <etm-tabs ref="tabs" v-model="activeName">
            <el-tab-pane v-if="hasAuth('newdaycare.attendanceStatisticsTeach.queryBatch', 'tabs', 'activeName')" label="早教考勤统计" name="teach">
              <etm-tool-bar v-show="true" v-model="teach" @search="handleSearch" />
            </el-tab-pane>
            <el-tab-pane v-if="hasAuth('newdaycare.attendanceStatisticsCare.queryBatch', 'tabs', 'activeName')" label="托育考勤统计" name="care">
              <etm-tool-bar v-show="true" v-model="care" @search="handleSearch2" />
            </el-tab-pane>
            <el-tab-pane v-if="hasAuth('newdaycare.attendanceStatisticsClazzGuard.query', 'tabs', 'activeName')" label="幼儿园班级考勤" name="clazz">
              <etm-tool-bar v-model="clazzFilters" @search="confirmQuery" @reset="resetQuery">
                日期:
                <el-date-picker
            ...
            <el-tab-pane v-if="hasAuth('newdaycare.attendanceStatisticsGuard.queryBatch', 'tabs', 'activeName')" label="幼儿园考勤统计" name="child">
              <etm-tool-bar v-model="childFilters" @search="confirmQuery" @reset="resetQuery">
                日期:
                <el-date-picker
        ...
        <div slot="body">
          <teach-list v-if="activeName==='teach'" :teach-search="teachSearch" />
          <care-List v-if="activeName==='care'" :care-search="careSearch" />
