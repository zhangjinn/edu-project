    ...
    <el-row :gutter="24">
      ...
      <el-col :span="12">
        <el-form-item
          ...
          label="班主任"
        >
          <el-select v-model="form.headTeacher" multiple placeholder="请选择班主任" @change="changeTeacher(form.headTeacher,'headTeacher')">
            <el-option
        ...
        <el-form-item
          ...
          label="老师"
        >
          <el-select v-model="form.teacher" multiple placeholder="请选择老师" @change="changeTeacher(form.teacher,'teacher')">
            <el-option
              v-for="item in teacherOptions"
              :key="item.value"
              :label="item.label"
