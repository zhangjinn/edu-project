  ...
  <div class="table">
    ...
    >
      <etm-table-tool-bar slot="tool">
        ...
        <el-button slot="right" v-has="{authId: 'guardcare.child.create'}" type="primary" @click="add"><i
        ...
        <el-button slot="right" v-has="{authId: 'guardcare.childLeave.createBatch'}" plain @click.native="leaveBatch">
          批量退园
        </el-button>
      </etm-table-tool-bar>
