    ...
    <etm-layout-split>
      <div slot="header">
        <etm-tabs v-model="activeName" :setting="false" :show-toggle="false">
          <el-tab-pane name="accountStatistics" label="幼儿账单统计">
            <etm-tool-bar v-model="formData" @search="handleSearch" @reset="reset" @change="change" />
          </el-tab-pane>
        </etm-tabs>
      </div>
      <div slot="body">
        ...
        >
          ...
          <!--<el-table-column slot="left" fixed="left" label="幼儿姓名" width="120">-->
          <!--  <template slot-scope="scoped">-->
          <!--    <div class="textCenter">{{ scoped.row.name }}</div>-->
          <!--  </template>-->
          <!--</el-table-column>-->
        </etm-table>
      </div>
