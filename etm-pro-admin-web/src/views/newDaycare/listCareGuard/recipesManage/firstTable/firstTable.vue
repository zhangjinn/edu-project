  ...
  <div>
    ...
    >
      <etm-table-tool-bar slot="tool">
        ...
        <el-button slot="right" v-has="{authId: 'guardcare.recipes.create'}" type="primary" @click="handleAdd"><i class="el-icon-plus" />&nbsp;&nbsp;添加食谱</el-button>
      </etm-table-tool-bar>
    ...
    >
      <div class="popContent">
        <add v-if="popVisibleEdit" ref="childPopForm" :semester-id="semesterId" />
      </div>
    </etm-pop>
  </div>
...
export default {
  ...
  methods: {
    ...
    switchToWeekRecipe() {
      this.$router.push({
        path: '/newdaycare_recipesGuard/recipesGuardEdit',
        query: {
