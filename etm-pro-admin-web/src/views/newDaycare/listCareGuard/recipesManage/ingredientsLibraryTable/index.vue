  ...
  <div>
    ...
    >
      <etm-table-tool-bar slot="tool">
        <div slot="right" class="btnBox">
          <el-button type="primary" @click="handleAdd"><i class="el-icon-plus" />&nbsp;&nbsp;添加食材</el-button>
        </div>
      </etm-table-tool-bar>
    ...
    >
      <div class="popContent">
        <edit v-if="popVisible && popType==='add'" ref="childPopForm" :type="popType" />
      </div>
    </etm-pop>
    ...
    <etm-drawer :visible.sync="drawerVisible">
      <etm-layout-split line>
        <etm-title :title="popTitle" border size="big">
          <template v-if="drawerVisible && popType==='edit'" slot="tool">
          ...
          <template v-if="drawerVisible && popType==='detail'" slot="tool">
            <el-button v-has="{authId: 'guardcare.food.update'}" plain size="mini" @click="handleEdit">编辑</el-button>
          </template>
        </etm-title>
        <div class="drawerBody">
          <detail v-if="drawerVisible && popType==='detail' && ingredientsId" :item-id="ingredientsId" />
          <edit v-if="drawerVisible && popType==='edit' && ingredientsId" ref="childPopForm" :type="popType" :item-id="ingredientsId" />
        </div>
      </etm-layout-split>
    </etm-drawer>
