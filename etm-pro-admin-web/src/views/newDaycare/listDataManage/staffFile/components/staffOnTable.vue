  ...
  <div class="staffOn-table-wrap">
    ...
    >
      <etm-table-tool-bar slot="tool">
        ...
        <div slot="right">
          <el-button type="primary" @click="handleAdd"><i class="el-icon-plus" />&nbsp;&nbsp;添加员工档案</el-button>
          <el-button type="primary" @click="updateOrg">&nbsp;从组织架构同步</el-button>
        </div>
      </etm-table-tool-bar>
      <template slot="left">
      ...
      <template slot="right">
        <el-table-column label="操作">
          <template v-slot="scoped">
            <etm-text type="primary" @click="handleEdit(scoped.row.employeeRecordId, true)">编辑</etm-text>
            <etm-text type="danger" @click="handleResign(scoped.row)">离职</etm-text>
            <etm-text type="danger" @click="handleRemove(scoped.row.employeeRecordId)">删除</etm-text>
          </template>
        </el-table-column>
      </template>
    </etm-table-page>
    ...
    <etm-drawer :visible.sync="isShowEditPopup" type="big">
      <etm-layout-split line>
        <etm-title :title="drawerTitle" border size="big">
          ...
          <template v-if="isShowEditPopup && drawerType==='detail'" slot="tool">
            <el-button plain size="mini" @click="handleEdit">编辑</el-button>
          </template>
        </etm-title>
        <div class="drawerBody">
          <detail v-if="isShowEditPopup && drawerType==='detail'" :employee-record-id="employeeRecordId" :employee-detail-data="employeeDetailData" />
          <edit v-else ref="edit" :type="drawerType" :employee-record-id="employeeRecordId" :employee-detail-data="employeeDetailData" />
        </div>
      </etm-layout-split>
    </etm-drawer>
    ...
    >
      <resign ref="resign" :resign-data="resignData" />
    </etm-pop>
  </div>
