<template>
  <div>
    <el-form ref="form" class="edit" :model="addForm" type="dialog" label-position="top" :inline="true">

      <!--基础信息栏-->
      <div class="basic">
        <etm-title :border="false" title="基础信息" />
        <div class="basic-form-item">
          <div class="basic-avatar" style="position:relative;">
            <img
              v-if="addForm.avatar"
              style="width: 130px;height: 130px"
              :src="addForm.avatar"
            >
            <img v-else src="@/assets/images/newDaycare/photo.png">
            <!--蒙层-->
            <div class="cover" />
            <el-button class="avatarBtn" size="mini" @click="handleAddAvatar"><i class="el-icon-plus" />添加图片</el-button>
            <input ref="addCoverRef" type="file" accept="image/*" style="display: none" @change="changeFileImg">
          </div>
        ...
        <div class="basic-form-item">
          <div class="basic-info clear-margin">
            ...
            >
              ...
              <!--/>-->
              <etm-address v-model="addForm.areaCode" :area-id="addForm.areaCode" />
            </el-form-item>
            <el-form-item
              label="家庭地址"
              prop="address"
