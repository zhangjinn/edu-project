<template>
  <div>
    <el-form ref="form" class="edit" :model="employeeDetailData" type="dialog" label-position="top" :inline="true">
        ...
        <div class="basic-form-item">
          <div class="basic-info clear-margin">
            ...
            <el-form-item
              ...
              style="width: 27%"
            >
              <etm-address v-model="employeeDetailData.areaCode" :area-id="employeeDetailData.areaCode" />
              <!--<el-input-->
