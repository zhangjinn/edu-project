          ...
          >
            ...
            <template slot="right">
              <el-table-column label="图片" prop="images">
                <template slot-scope="{row}">
                  <etm-text v-if="row.image.length" @click="handleShowImg(row)">查看图片</etm-text>
                  <div v-else>--</div>
                </template>
              </el-table-column>
            </template>
            <template slot="right">
              <el-table-column label="交代人" prop="tellName">
                <template slot-scope="{row}">
            ...
            <template slot="right">
              <el-table-column show-overflow-tooltip label="交代时间" prop="tellTime" />
            </template>
            <template slot="right">
              <el-table-column label="确认老师" prop="employeeName" />
            </template>
            <template slot="right">
              <el-table-column show-overflow-tooltip label="确认时间" prop="confirmTime" />
            </template>
            <template slot="right">
              <el-table-column label="状态" prop="tellState">
                <template slot-scope="scope">
                  <etm-status :type="setStatus(scope)">{{ scope.row.tellState }}</etm-status>
                </template>
              </el-table-column>
            </template>
            <template slot="right">
              <el-table-column label="操作" prop="operate">
                <template slot-scope="{row}">
                  <template v-if="row.tellState === '待确认'">
                    <etm-text @click="handleConfirm(row)">确认</etm-text>
                  </template>
                </template>
              </el-table-column>
            </template>
