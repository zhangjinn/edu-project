    ...
    >
      <div class="addCourse-wrap">
        <etm-form ref="etmForm" type="dialog" :model="form" :rules="rules">
          ...
          <el-form-item label="授课老师" prop="teachTeacherId">
          ...
          <el-form-item label="起止日期" prop="timeStep">
            <el-date-picker
          ...
          <el-form-item label="每周重复日" prop="weekdayList">
            ...
            <el-select v-model="form.weekdayList" multiple>
              <el-option
          ...
          <el-form-item label="日程时段" prop="courseTimePeriodIdList">
            <!--            <etm-check-box :check-list="list" @change="dayChange" />-->
            <el-select v-model="form.courseTimePeriodIdList" multiple>
              <el-option v-for="(item, index) in list" :key="index" :label="item.name" :value="item.value" />
            </el-select>
          </el-form-item>
