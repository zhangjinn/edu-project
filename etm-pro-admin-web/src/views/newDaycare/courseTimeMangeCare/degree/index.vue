<template>
  <div class="index-wrap">
      ...
      <etm-calendar v-model="currentDate">
        <template slot="dateCell" slot-scope="{date, data}">
          ...
          <template v-if="hasArrange(data)">
            ...
            <div v-if="!getArrange(data).offFlag" :class="['calendar-box']" @click.stop="changeDay(data)">
            ...
            <div v-else :class="['calendar-box', 'xiuxi']" @click.stop="">
              <div class="calendar-day">{{ month(data) }}-{{ day(data) }}</div>
              <div class="current-day">休息</div>
            </div>
          </template>
          <template v-else>
    ...
    <degree-detail ref="popDetail" :props="childProp" />
  </div>
