  ...
  <div class="index-wrap">
    <etm-layout-split>
      <template slot="header">
        <etm-tabs ref="tabs" v-model="activeName" @setting="setting">
          ...
          <!--            />-->
          <!--          </el-tab-pane>-->
          <el-tab-pane v-if="hasAuth('daycare.room.queryBatch', 'tabs', 'activeName')" label="教室" name="class">
            <etm-tool-bar v-model="formData_class" @search="handleSearch($event, 'formData_class')" @reset="reset" />
          </el-tab-pane>
        </etm-tabs>
      </template>
      <template slot="body">
        <keep-alive>
          <component :is="tabComponent[activeName]" :search="searchInfo" :teacher="teacherList" />
        </keep-alive>
      </template>
    </etm-layout-split>
  </div>
