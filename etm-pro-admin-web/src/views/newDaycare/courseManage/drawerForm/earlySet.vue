<template>
  <div class="earlySet">
    ...
    <!--    </etm-form>-->
    <div>
      <etm-field-label label="早教课时总计" type="left">{{ lessonTotal }}</etm-field-label>
      <etm-field-label label="购买课时总计" type="left">{{ buyLessonTotal }}</etm-field-label>
      <etm-field-label label="赠送课时总计" type="left">{{ handselLessonTotal }}</etm-field-label>
