<template>
  <div class="nurseCourse">
    <etm-form ref="form" type="dialog" :model="formData" :rules="rules">
      ...
      <el-form-item label="托育名称" prop="name">
        <el-input v-model="formData.name" placeholder="请输入托育名称" />
      </el-form-item>
      <el-form-item label="托育类型" prop="nurseType">
        <el-select v-model="formData.nurseType" placeholder="请选择托育类型">
          <el-option v-for="option in typeList" :key="option.value" :label="option.label" :value="option.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="托育年龄段" prop="nurseType">
        <el-select v-model="formData.generationId" placeholder="请选择托育年龄段">
          <el-option v-for="option in period" :key="option.generationId" :label="option.generationName" :value="option.generationId" />
        </el-select>
      </el-form-item>
      <el-form-item label="消课天数" prop="courseTime">
        <el-input
      ...
      <el-form-item label="托育时长" prop="nurseType">
        <el-select v-model="formData.duration">
          <el-option label="半天" value="HALF_DAY" />
          <el-option label="全天" value="ONE_DAY" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="课程容量" prop="totalCapacity" class="capactiy">
        <div class="capacity-row">
          <div class="capcity-label">总&ensp;学&ensp;位</div>
          <div>
            <el-input
        ...
        <div class="capacity-row">
          <div class="capcity-label">正式学位</div>
          <div>
            <el-input
        ...
        <div class="capacity-row">
          <div class="capcity-label">试听学位</div>
