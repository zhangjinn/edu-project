<template>
  <div class="earlyCourse">
    <etm-form ref="form" type="dialog" :model="formData" :rules="rules">
      ...
      <el-form-item :rules="formValidate.nullValueRule(true, '请输入课程名称', ['change'])" label="课程名称" prop="name">
        <el-input v-model="formData.name" v-in-focus placeholder="请输入课程名称" />
      </el-form-item>
      ...
      <el-form-item label="消课课时" prop="courseTime">
        <el-input
