      ...
      <etm-layout-split>
        <etm-title :show-line="false" border size="big">
          ...
          <template slot="tool">
            ...
            <template v-else>
              <el-button v-if="prop.contractType === '新签约' || prop.contractType === '续约'" type="primary" size="mini" @click="printContract">打印</el-button>
              <el-button
                v-if="prop.contractType !== '转课' && prop.contractStatusEnum !== '退费' && prop.contractStatusEnum !== '转课' && prop.contractStatusEnum != '作废'"
        ...
        <component :is="components[isEdit ? 'edit' : 'text']" ref="component" :prop="prop" />
...
import chargeDetailEdit from '@/views/newDaycare/contract/careContract/components/chargeDetailEdit'
import chargeDetailText from '@/views/newDaycare/contract/careContract/components/chargeDetailText'
