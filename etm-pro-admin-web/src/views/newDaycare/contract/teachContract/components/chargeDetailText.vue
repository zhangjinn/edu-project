<template>
  <div class="chargeDetailText-wrap">
    <el-row class="row">
      ...
      <el-col v-if="detailData.contractType == 'TRANSFER_COURSE' && !print" :span="8">
      ...
      <el-col v-if="!print" :span="8">
        <etm-field-label label="合同状态">{{
          contractStatusEnum[detailData.contractStatusEnum]
        }}
        </etm-field-label>
      </el-col>
      <el-col v-if="detailData.contractStatusEnum == 'AUDIT_FAILED' && !print" :span="8">
    ...
    <div v-if="detailData.contractType != 'TRANSFER_COURSE'">
      ...
      <el-row class="row">
        ...
        <el-col :span="8">
          <etm-field-label label="有效期">{{ detailData.validBeginTime }}至{{
    ...
    <template v-if="print">
      <div class="print">
        <div class="agent">经办人签名：</div>
        <div class="customer">客户签名：</div>
      </div>
    </template>
  </div>
