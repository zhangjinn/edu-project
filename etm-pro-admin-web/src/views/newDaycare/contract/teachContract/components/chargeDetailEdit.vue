<template>
  <div class="chargeDetailEdit-wrap">
    <div v-if="!enable">
      ...
      <etm-field-label label="业务类型" type="left">早教</etm-field-label>
    ...
    <div class="itemTable">
      ...
      <div v-if="enable" class="buttonBox">
        <el-button type="dashed" @click="selectEvent('earlySetMeal')"><i class="iconfont iconplus" />选择套餐</el-button>
        <el-button type="dashed" @click="selectEvent('earlyType')"><i class="iconfont iconplus" />选择课程类型</el-button>
        <el-button type="dashed" @click="selectEvent('earlyCourse')"><i class="iconfont iconplus" />选择课程</el-button>
        <el-button type="dashed" @click="selectEvent('item')"><i class="iconfont iconplus" />选择物品</el-button>
        <el-button type="dashed" @click="selectEvent('fee')"><i class="iconfont iconplus" />选择费用</el-button>
      </div>
    ...
    <div>
      ...
      <el-row>
        <el-col :span="24">
          <etm-form ref="form2" type="dialog">
    ...
    <div>
      ...
      <el-row>
        <el-col :span="24">
          <etm-form ref="form3" type="dialog">
