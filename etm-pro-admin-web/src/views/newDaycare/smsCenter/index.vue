        ...
        <div slot="header">
          <div class="customerTabItem">
            <etm-tabs v-model="activeName" :setting="true" @setting="setting">
              <span slot="tool">
                <el-button type="text" @click="showPop = true">余额查询</el-button>
              </span>
        ...
        <div slot="body">
          <template v-if="activeName === 'sms'">
            ...
            >
              ...
              <el-table-column slot="right" label="发送情况" width="120">
              ...
              <el-table-column slot="right" label="操作" width="80">
                <template v-slot="scoped">
                  <template v-if="scoped.row.sendResult!=='成功'">
                    <etm-text type="primary" @click="handleSend(scoped.row.id)">重发</etm-text>
                  </template>
                </template>
              </el-table-column>
            </etm-table-page>
