  ...
  <div class="msgTemplate-wrap">
    <etm-table-tool-bar slot="tool">
      <el-input v-model.trim="search" placeholder="请输入搜索内容" @keyup.native.enter="query">
        <i slot="suffix" class="el-icon-search el-input__icon" @click.stop="queryInit" />
      </el-input>
      <el-button slot="right" type="primary" @click.stop="addTemplate"><i class="el-icon-plus" />&nbsp;&nbsp;新建模板
      </el-button>
    </etm-table-tool-bar>
    <etm-table
      :columns="columns"
    ...
    >
      ...
      >
        <template slot-scope="scoped">
          ...
          <etm-text type="danger" @click.stop="deleteTemplate(scoped.row)">删除</etm-text>
        </template>
      </el-table-column>
    </etm-table>
    <etm-pop
    ...
    >
      <etm-form ref="form" type="dialog" :model="formData">
        <el-form-item
          label="模板名称"
          prop="name"
