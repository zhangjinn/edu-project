<template>
  <div class="feedback-wrap">
      ...
      <etm-layout-split>
        <div slot="header">
          <etm-tabs ref="tabs" v-model="activeName">
            ...
            <el-tab-pane label="家长反馈" name="parent">
              <etm-tool-bar v-model="parentFilter" @search="handleSearch" @reset="handleReset" />
            </el-tab-pane>
            <el-tab-pane label="我的反馈" name="mine">
              <etm-tool-bar v-model="mineFilter" @search="handleSearch" @reset="handleReset" />
            </el-tab-pane>
          </etm-tabs>
        </div>
        <div slot="body">
    ...
    >
      <add v-if="popTitle === '添加意见反馈'" ref="add" />
      <etm-form v-else ref="form" :model="formData" type="dialog" :rules="rules">
    ...
    >
      <etm-layout-split>
        <etm-title :show-line="false" border size="small">
          编辑意见反馈
          <template slot="tool">
            <el-button plain size="mini" @click.stop="handleDrawerCancel">取消</el-button>
            <el-button
              type="primary"
              size="mini"
