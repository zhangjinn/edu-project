<template>
  <etm-form ref="form" :model="formData" type="dialog" :rules="rules">
    <el-form-item label="问题和意见" prop="content">
    ...
    <el-form-item label="发送对象" prop="target">
      <el-checkbox-group v-model="formData.target">
        <el-checkbox v-if="enterpriseType" label="GARDEN">园所</el-checkbox>
        <el-checkbox v-if="enterpriseType === 'GARDEN'" label="AREA">区域</el-checkbox>
        <el-checkbox v-if="enterpriseType === 'GARDEN' || enterpriseType === 'AREA'" label="HEADQUARTERS">总部</el-checkbox>
      </el-checkbox-group>
    </el-form-item>
  </etm-form>
</template>
