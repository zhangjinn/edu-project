        ...
        <div slot="body">
          ...
          >
            ...
            <el-table-column slot="left" label="1月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.jan, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="2月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.feb, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="3月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.mar, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="4月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.apr, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="5月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.may, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="6月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.june, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="7月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.july, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="8月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.aug, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="9月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.sept, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="10月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.oct, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="11月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.nov, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="12月" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.dece, scoped.$index) }}</span>
              </template>
            </el-table-column>
            <el-table-column slot="right" fixed="right" label="总计" width="120" align="right">
              <template slot-scope="scoped">
                <span :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.total, scoped.$index) }}</span>
              </template>
            </el-table-column>
          </etm-table>
        </div>
...
export default {
  ...
  methods: {
    ...
    formatMoney(money, index) {
      if (index === (this.tableData.incomeNum + this.tableData.expenditrueNum)) {
        if (money > 0) {
