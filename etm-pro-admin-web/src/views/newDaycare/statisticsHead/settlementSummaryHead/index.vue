      ...
      <etm-layout-split>
            ...
            <el-tab-pane :label="tabPlanLabel">
              <etm-tool-bar v-show="true" v-model="formData" @search="handleSearch" @reset="handleReset">
                <el-form-item label="园所：">
                  <etm-area-garden-cascader :clear="clear" @change="getOrganizationId" />
                </el-form-item>
                <el-form-item label="结算科目：">
                  <el-input v-model="searchForm.settlementItem" placeholder="请输入结算科目" />
                </el-form-item>
              </etm-tool-bar>
            </el-tab-pane>
          </etm-tabs>
        ...
        <div slot="body">
          ...
          >
            ...
            <el-table-column slot="left" label="结算可退总金额（元）" align="right">
              <template slot-scope="scoped">
                <div :class="getClass(scoped.$index) ? 'main' : ''">{{
            ...
            <el-table-column slot="left" label="应消总金额（元）" align="right">
              <template slot-scope="scoped">
                <div :class="getClass(scoped.$index) ? 'main' : ''">{{ formatMoney(scoped.row.amountPayable) }}</div>
              </template>
            </el-table-column>
            <el-table-column slot="right" label="实消总金额（元）" align="right">
              <template slot-scope="scoped">
                <div :class="getClass(scoped.$index) ? 'main' : ''">{{
