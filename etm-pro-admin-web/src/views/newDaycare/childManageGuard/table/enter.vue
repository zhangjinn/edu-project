  ...
  <div class="table">
    ...
    >
      <etm-table-tool-bar slot="tool">
        <div slot="right">
          <el-button slot="right" type="primary" @click="add">
          ...
          <el-dropdown slot="right">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="importChild">导入幼儿信息
              </el-dropdown-item>
              <el-dropdown-item @click.native="toImportBatch">导入批次管理
              </el-dropdown-item>
              <el-dropdown-item
                @click.native="adjustBatch"
              >批量调班
              </el-dropdown-item>
              <el-dropdown-item @click.native="leaveBatch">批量退园
              </el-dropdown-item>
      ...
      <el-table-column slot="right" label="操作" fixed="right" width="300">
        <template slot-scope="scoped">
          ...
          <etm-text type="primary" @click="adjust(scoped.row)">
            调班
          </etm-text>
          <etm-text type="primary" @click="leave(scoped.row)">退园
          </etm-text>
    ...
    >
      <detail
        ...
        @close="closeDrawer"
      />
      <parent-drawer v-else-if="showDrawer" :child-id="childId" :child-name="childName" />
    </etm-drawer>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    toImportBatch() { // 导入批次管理页面
      this.$router.push({
        path: '/newdaycare_childManageGuardcare/importManage'
      })
    },
    adjustBatch() { // 批量调班弹窗
      this.addTitle = '批量调班'
