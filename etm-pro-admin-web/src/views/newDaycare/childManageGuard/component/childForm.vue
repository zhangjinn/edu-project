        ...
        <div class="contactBox">
          ...
          >
            ...
            <el-form-item :prop="'contactList.'+ index +'.name'" :rules="rule.name">
              <el-input v-model="item.name" placeholder="联系人姓名" :disabled="disabledInput[index]" @blur="verifyChild" />
            </el-form-item>
  ...
  methods: {
    ...
    checkPhone(value, index) {
      if (!this.oldPhoneNumber.includes(value) && validPhoneNumber(value)) {
        ...
        createParentPhoneCheck(param).then(res => {
          const data = res.data
    ...
    verifyChild() {
      if (this.formType !== 'add') {
        ...
        createChildRepeat(param).then(res => {
