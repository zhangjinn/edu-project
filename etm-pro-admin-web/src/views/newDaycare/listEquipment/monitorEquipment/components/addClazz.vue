<template>
  <etm-form :model="form" type="dialog">
    <el-form-item label="教室名称" prop="name" required>
      <el-input
        v-model="form.name"
        placeholder="请输入教室名称"
      />
    ...
    <el-form-item label="教室详情" prop="detail">
      <el-input
        v-model="form.detail"
        type="textarea"
        placeholder="请输入教室详情"
    ...
    <el-form-item label="上传展示图片" prop="pictures">
      <etm-upload-img
        :resource-name="'daycare/monitorEquipment/addClazz'"
