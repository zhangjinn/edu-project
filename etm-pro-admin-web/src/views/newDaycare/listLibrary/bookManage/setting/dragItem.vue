  ...
  <div class="dragItem">
    <draggable v-model="listData" :handle="handle" filter="._filter" @change="change">
      <div v-for="(item, index) in listData" :key="index" class="item">
        <div v-if="noSlot.indexOf('color') === -1" :class="showColor ? 'colorWrap' : ''">
        ...
        <div class="greyWrap">
          ...
          <div
            ...
            :class="item.editable === false ? 'deleteWrap _nodelete hidden' : 'deleteWrap'"
          ...
          <div
            ...
            :class="[item.move === false ? 'handleWrap _filter' : 'handleWrap', item.editable === false ? 'hidden' : '']"
          >
            <slot name="handle" />
          </div>
        </div>
