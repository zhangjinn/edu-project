<template>
  <div class="resolveVisit-wrap">
    <etm-pop
      ...
      @confirm="confirm"
    >
      <etm-form ref="form" type="dialog" :model="form" :rules="rules">
        ...
        <el-form-item label="到访情况" prop="visits">
          <el-input v-model="form.visits" type="textarea" :rows="6" placeholder="请输入到访情况" />
        </el-form-item>
      </etm-form>
    </etm-pop>
  </div>
