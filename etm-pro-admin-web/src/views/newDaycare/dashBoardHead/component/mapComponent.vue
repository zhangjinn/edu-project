<template>
  <div class="mapComponent-wrap">
    <div ref="mapChart" style="width: 100%;height: 600px;" />
    <div class="scaleBtn">
      <div class="iconBtn" @click="reduceScale">
        <span class="iconfont iconminus" />
      </div>
      <div class="iconBtn" @click="addScale">
      ...
      myChart.setOption({
        ...
        tooltip: {
          ...
          formatter: function(param) {
            ...
            const res = `<div style="padding: 16px 0 0 16px;font-size: 16px;">${data.name}</div>
                        <div style="padding: 12px 16px 0 16px;">
                        <span style="display: inline-block;width: 96px;">幼儿园容量</span>
                        <span style="display: inline-block;width: 48px;">${data.guardFullAmount}</span>
                        <span style="display: inline-block;width: 96px;">托育园容量</span>
                        ...
                        <div style="padding: 4px 0 16px 16px;">
...
.mapComponent-wrap {
  ...
  .scaleBtn{
    ...
    .iconBtn{
      ...
      border-radius: 4px;
      cursor: pointer;
      box-shadow: 0px 4px 8px 0px rgba(34, 34, 34, 0.1);
      .iconfont{
        width: 24px;
        font-size: 12px;
      }
