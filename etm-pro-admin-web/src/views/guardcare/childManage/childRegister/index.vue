    ...
    >
      <etm-layout-split>
        ...
        <div ref="print" class="printBox">
          ...
          <div class="printContent" style="padding-bottom: 32px;font-size: 14px;color: #555;text-indent: 16px;" v-html="contentText" />
...
<script>
import { getRegistration, getRegistrationUrl, renewRegistration } from '@/api/guardcare/childManage/childManage'
