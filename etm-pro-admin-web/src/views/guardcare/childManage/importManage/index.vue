    ...
    <etm-main-body>
      <etm-layout-split>
        <div slot="header">
          <div>
            <etm-tabs v-model="activeName">
              <el-tab-pane label="导入批次管理" name="batch">
        ...
        <div slot="body">
          ...
          >
            <el-table-column slot="left" label="批次号" width="200">
              <template slot-scope="scoped">
                <a @click="showDetail(scoped.row)">{{ scoped.row.batchNumber }}</a>
              </template>
            </el-table-column>
            <el-table-column slot="left" label="批次状态" width="120">
              <template slot-scope="scoped">
            ...
            <el-table-column slot="right" label="操作" width="120">
              <template slot-scope="scoped">
                <etm-text v-if="scoped.row.status === 'NORMAL'" type="danger" @click="revoke(scoped.row)">撤销</etm-text>
              </template>
            </el-table-column>
          </etm-table-page>
        </div>
 ...
 * createTime 2020/9/2 15:48
 */

import { getImportBatch, revokeBatch } from '@/api/guardcare/childManage/childManage'
