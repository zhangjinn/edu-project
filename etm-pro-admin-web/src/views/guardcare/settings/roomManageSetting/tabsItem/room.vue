...
import { getRoomType, postRoomType, putRoomType, delRoomType, putRoomSort } from '@/api/guardcare/edu/roomManage'
export default {
  components: {
    itemTemplate
  },
  ...
  methods: {
    ...
    handleChange() {
      ...
      roomTypeList.roomTypeList = ids
      putRoomSort(roomTypeList).then(res => {
    ...
    deleteItem(e) {
      ...
      delRoomType(this.dragData[e[0].index].id).then(res => {
