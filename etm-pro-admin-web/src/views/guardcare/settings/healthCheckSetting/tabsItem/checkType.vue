...
import { createCheckType, updateCheckType, queryCheckTypeList, removeCheckType, sortCheckTypeList } from '@/api/guardcare/careManage/healthCheck'
export default {
  components: {
    itemTemplate
  },
  ...
  methods: {
    ...
    handleChange() {
      ...
      sortCheckTypeList(ids).then(res => {
    ...
    deleteItem(e) {
      ...
      removeCheckType(this.dragData[e[0].index].id).then(res => {
