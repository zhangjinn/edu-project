...
<script>
import EtmWeeklyCalendar from '@/views/guardcare/edu/scheduleManage/components/EtmWeeklyCalendar/index'
import EtmCell from './recommendedRecipeCell'
import { queryWeekRecipe, queryWeekRecipeDetail } from '@/api/base/base'
import { checkRecommendedRecipes, putRecommendedRecipes } from '@/api/guardcare/careManage/recipesManage'
export default {
