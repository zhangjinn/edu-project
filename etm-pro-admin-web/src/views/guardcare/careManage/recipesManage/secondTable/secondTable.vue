  ...
  <div>
    ...
    >
      ...
      <el-table-column slot="right" label="操作">
        <template v-slot="scoped">
          <etm-text v-has="{authId: 'guardcare.food.update'}" type="primary" @click="handleEdit(scoped.row)">编辑</etm-text>
          <etm-text v-has="{authId: 'guardcare.food.remove'}" type="danger" @click="handleDelete(scoped.row)">删除</etm-text>
        </template>
      </el-table-column>
    </etm-table-page>
