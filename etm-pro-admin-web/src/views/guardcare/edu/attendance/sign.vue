<template>
  <div class="sign-wrap">
    <div v-if="state === 'attendance'" class="attendanceBox">
      <div class="imgBox">
    ...
    <div v-else-if="state === 'success'" class="successBox">
      <div class="imgBox">
        ...
        <div class="msgBox">
          <div class="list">
            <div class="avatar">
              <img v-if="attendanceData.childAvatar" :src="attendanceData.childAvatar">
          ...
          <div class="list">
            <div class="avatar">
              <img v-if="attendanceData.parentAvatar" :src="attendanceData.parentAvatar">
              <span v-else class="iconfont iconmorentouxiang" />
            </div>
            <div class="rightBox">
              <div class="name">
    ...
    <div v-else-if="state === 'abnormal' || state === 'notEnrollment'" class="abnormalBox">
      <div class="imgBox">
        <img src="../../../../assets/images/guardcare/attendance_abnormal.png">
        <div class="text">{{ state === 'abnormal' ? '刷卡异常，未找到匹配的宝贝' : '未到入托日期哦' }}</div>
      </div>
    </div>
    <div v-else-if="state === 'repeat'" class="repeatBox">
      <div class="imgBox">
        <img src="../../../../assets/images/guardcare/attendance_repeat.png">
      </div>
    </div>
    <div class="inputBox">
      <el-input ref="input" v-model="attendanceCardNumber" placeholder="可输入接送卡号" size="big" />
    </div>
    <div class="btnBox">
      <el-button type="primary" size="big" :disabled="!attendanceCardNumber" @click="submit">确认</el-button>
    </div>
  </div>
...
import { createAttendanceByCard } from '@/api/guardcare/edu/attendance'
