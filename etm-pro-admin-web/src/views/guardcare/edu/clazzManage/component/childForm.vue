  ...
  <div class="form">
    ...
    <etm-form ref="form" :model="formData" :rules="rule" type="dialog">
      ...
      <el-form-item label="幼儿姓名" prop="childName">
        <el-input v-model="formData.childName" placeholder="请输入幼儿姓名" />
      </el-form-item>
      ...
      <etm-form :model="formData" type="dialog">
        ...
        <el-form-item label="健康状况">
          <el-select v-model="formData.healthCondition" placeholder="请选择健康状况">
            <el-option v-for="(blood, i) in healthList" :key="i" :label="blood.label" :value="blood.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="曾患疾病">
          <el-select v-model="formData.onceSick" multiple placeholder="请选择疾病状况" @change="$forceUpdate()">
            <el-option v-for="(blood, i) in sickList" :key="i" :label="blood.label" :value="blood.value" />
          </el-select>
        </el-form-item>
        ...
        contactList: [{
          required: true, trigger: 'blur', validator: (rule, value, callback) => {
            value.forEach(item => {
              ...
              } else if (!validPhoneNumber(item.telephone)) {
