<template>
  <div class="detail">
    <ul class="list-wrapper">
      <li><etm-field-label label="年级">{{ baseInfo.gradeName }}</etm-field-label></li>
      <li><etm-field-label label="班主任">{{ baseInfo.headTeacher }}</etm-field-label></li>
      <li><etm-field-label label="班级名称">{{ baseInfo.clazzName }}</etm-field-label></li>
      <li><etm-field-label label="副班老师">{{ baseInfo.teacher }}</etm-field-label></li>
    </ul>
  </div>
</template>
