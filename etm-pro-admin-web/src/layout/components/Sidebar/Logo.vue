<template>
  <div class="sidebar-logo-container" :class="[collapse?'collapse':'noCollapse']">
    <transition name="sidebarLogoFade">

      <router-link v-if="collapse" key="collapse" class="sidebar-logo-link" to="/">
        <span v-if="getOrganizationLogo.organizationLogo" class="sidebar-logo-box sidebar-logo-box-small organization-logo-small">
          <img class="sidebar-logo-small" :src="getOrganizationLogo.organizationLogo" alt="logo">
        </span>
        <span v-else class="sidebar-logo-box sidebar-logo-box-small default-logo-small">
          <img class="sidebar-logo-small" :src="defaultLogoSmall" alt="logo">
        </span>
      </router-link>
      <router-link v-else key="expand" class="sidebar-logo-link" to="/">
        <span v-if="getOrganizationLogo.organizationLogo" class="sidebar-logo-box sidebar-logo-box-big organization-logo-big">
          <img class="sidebar-logo-big" :src="getOrganizationLogo.organizationLogo" alt="logo">
        </span>
        <span v-else class="sidebar-logo-box sidebar-logo-box-big  default-logo-big">
          <img class="sidebar-logo-big" :src="defaultLogoBig" alt="logo">
        </span>
        <!--        <etm-logo />-->
      </router-link>
    </transition>
