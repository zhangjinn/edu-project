...
export function queryBookLendingDetails({ startDate, endDate, reviewStartDate, reviewEndDate, borrowingStatus, bookManageName, childName, bookLendStatus, pageNum, pageSize, paged, sort }) {
  return request({
    url: `/daycare/book_lending_details/lend`,
    method: 'get',
...
export function queryLibraryDetailPop({ bookManageId }) {
  return request({
    url: `/daycare/book_manage/${bookManageId}`,
    method: 'get',
    params: {}
  })
}
...
export function queryGiveBackDetail({ bookBarcode }) {
  return request({
    url: `/daycare/book_lending_details/find_barcode/${bookBarcode}`,
    method: 'get',
    params: {}
  })
}
...
export function updateGiveBackLibrary({ bookLendingDetailsId, bookBarcode, storageLocation }) {
  return request({
    url: `/daycare/book_lending_details/return/${bookLendingDetailsId}`,
    method: 'put',
...
export function updateBreakage({ bookLendingDetailsId }) {
  return request({
    url: `/daycare/book_lending_details/damaged/${bookLendingDetailsId}`,
    method: 'put',
    data: {}
  })
}
...
export function queryRenewalDetail({ bookLendingDetailsId }) {
  return request({
    url: `/daycare/book_lending_details/${bookLendingDetailsId}`,
    method: 'get',
    params: {}
  })
}
...
export function createLendRegister({ bookBarcode, childId, phone, createDate, duration, endDate }) {
  return request({
    url: `/daycare/book_lending_details`,
    method: 'post',
...
export function queryStoreDetailList({ bookManageName, bookTypeId, bookStatus, pageNum, pageSize, paged, sort }) {
  return request({
    url: `/daycare/book_inventory_details`,
    method: 'get',
...
export function queryStoreDetailStatistics() {
  return request({
    url: `/daycare/book_inventory_details/statistics`,
    method: 'get',
    params: {}
  })
}
...
export function createStore({ bookManageId, storageLocation, storageCount }) {
  return request({
    url: `/daycare/book_manage/warehousing`,
    method: 'post',
...
export function autoGenerateCoding() {
  return request({
    url: `/daycare/book_manage/coding`,
    method: 'get',
    params: {}
  })
}
...
export function removeBookType({ bookTypeId }) {
  return request({
    url: `/daycare/book_type/${bookTypeId}`,
    method: 'delete',
    data: {}
  })
}
