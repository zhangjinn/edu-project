...
export function updateNotification({ noticeId }) {
  return request({
    url: `/daycare/notice/release_notice/${noticeId}`,
    method: 'put',
    data: {}
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function createNewNotification({ notificationTitle, notificationContent, dynamicReleaseScopeDTOList, postStatus }) {
  return request({
    url: `/daycare/notice`,
    method: 'post',
...
export function queryReadCount({ noticeId }) {
  return request({
    url: `/daycare/notice/reading_statistics/${noticeId}`,
    method: 'get',
    params: {}
  })
}
...
export function queryIsNotification({ noticeId }) {
  return request({
    url: `/daycare/notice/release_or_not/${noticeId}`,
    method: 'get',
    params: {}
  })
}
