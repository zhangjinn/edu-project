 ...
 * @returns {AxiosPromise}
 */
export function queryAttendanceCare({ type, childName, clazzName, startDate, endDate, pageNum, pageSize, paged }) {
  return request({
    url: `/daycare/ca_aattendance`,
    method: 'get',
    params: { type, childName, clazzName, startDate, endDate, pageNum, pageSize, paged }
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function updateAttendanceCare({ caAattendanceIdList, status, personRelationId, reason }) {
  return request({
    url: `/daycare/ca_aattendance`,
    method: 'put',
    data: { caAattendanceIdList, status, personRelationId, reason }
  })
}
...
export function queryAttendanceCareSetting() {
  return request({
    url: `/daycare/ca_aattendance_setting`,
    method: 'get'
  })
}
...
export function updateAttendanceCareSetting({ caAattendanceSettingId, value, enable }) {
  return request({
    url: `/daycare/ca_aattendance_setting/${caAattendanceSettingId}`,
    method: 'put',
...
export function createDelAttendanceCare({ idList }) {
  return request({
    url: `/daycare/ca_schild_course/cancel`,
    method: 'post',
    data: { idList }
  })
}
