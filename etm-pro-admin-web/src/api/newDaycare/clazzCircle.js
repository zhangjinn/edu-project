...
export function removeDynamic({ dynamicId }) {
  return request({
    url: `/newdaycare/dynamic/${dynamicId}`,
    method: 'delete',
    data: {}
  })
}
...
export function queryAllLesson() {
  return request({
    url: `/newdaycare/dynamic/authorization`,
    method: 'get',
    params: {}
  })
}
...
export function createDynamic({ content, dynamicType, urlList, dynamicReleaseScopeDTOList, canComment, dynamicCover }) {
  return request({
    url: `/newdaycare/dynamic`,
    method: 'post',
    data: { content, dynamicType, urlList, dynamicReleaseScopeDTOList, canComment, dynamicCover }
  })
}
...
export function queryPreviewDynamic({ dynamicId }) {
  return request({
    url: `/newdaycare/dynamic/preview_dynamic/${dynamicId}`,
    method: 'get',
    params: {}
  })
}
