 ...
 * @returns {AxiosPromise}
 */
export function createNurseContract({ dateOfAdmission, extensionDay, annex, contractNo, childId, contractType, receivable, paid, paymentId, date, validBeginTime, validEndTime, mainPerformanceId, mainPercentage, secondaryPerformanceId, secondaryPercentage, remake, earnestMoneyId, listPurchaseItemsDTO }) {
  return request({
 ...
 * @returns {AxiosPromise}
 */
export function createEarlyContract({ annex, contractNo, childId, contractType, receivable, paid, paymentId, date, validBeginTime, validEndTime, mainPerformanceId, mainPercentage, secondaryPerformanceId, secondaryPercentage, remake, earnestMoneyId, listPurchaseItemsDTO }) {
  return request({
...
export function queryMoneyLists(childId, earnestMoneyId) {
  let url = `/newdaycare/earnest_money/child/${childId}`
