...
export function queryNurseriesList({ teacherId, clazzName, lastPositionEnum, pageNum, pageSize, paged }) {
  return request({
    url: `/newdaycare/care/cae_clazz/clazz_page`,
    method: 'get',
...
export function queryClassChildren({ clazzId, childName }) {
  return request({
    url: `/newdaycare/care/cae_clazz/clazz_child`,
    method: 'get',
...
export function removeClass({ caeClazzId }) {
  return request({
    url: `/newdaycare/care/cae_clazz/${caeClazzId}`,
    method: 'delete',
    data: {}
  })
}
...
export function getOutClass({ childId, clazzId }) {
  return request({
    url: `/newdaycare/care/cae_clazz/retreat`,
    method: 'post',
    data: {
      clazzId,
      childId
...
export function exchangeClass({ childIdList, currentClazzId, clazzId }) {
  return request({
    url: `/newdaycare/care/cae_clazz/adjustmente`,
    method: 'post',
...
export function queryAllChildren() {
  return request({
    url: `/newdaycare/care/cae_clazz/not_clazz_child`,
    method: 'get',
    params: {}
  })
}
...
export function createJoinChildren({ clazzId, childIdList }) {
  return request({
    url: `/newdaycare/care/cae_clazz/add_child`,
    method: 'post',
...
export function queryTeachNurseriesList({ teacherId, clazzName, lastPositionEnum, pageNum, pageSize, paged }) {
  return request({
    url: `/newdaycare/teach/te_clazz/clazz_page`,
    method: 'get',
    params: { teacherId, clazzName, lastPositionEnum, pageNum, pageSize, paged }
  })
}
...
export function queryTeachClassChildren({ clazzId, childName }) {
  return request({
    url: `/newdaycare/teach/te_clazz/clazz_child`,
    method: 'get',
    params: { clazzId, childName }
  })
}
...
export function removeTeachClass({ teClazzId }) {
  return request({
    url: `/newdaycare/teach/te_clazz/${teClazzId}`,
    method: 'delete',
    data: {}
  })
}
...
export function getOutTeachClass({ childId, clazzId }) {
  return request({
    url: `/newdaycare/teach/te_clazz/retreat`,
    method: 'post',
    data: {
      clazzId,
      childId
...
export function exchangeTeachClass({ childIdList, currentClazzId, clazzId }) {
  return request({
    url: `/newdaycare/teach/te_clazz/adjustmente`,
    method: 'post',
    data: { childIdList, currentClazzId, clazzId }
  })
}
...
// export function queryAllChildren() {
//   return request({
//     url: `/newdaycare/child/down_search`,
//     method: 'get',
//     params: {}
//   })
// }
...
export function createJoinTeachChildren({ clazzId, childIdList }) {
  return request({
    url: `/newdaycare/teach/te_clazz/add_child`,
    method: 'post',
    data: { clazzId, childIdList }
  })
}
