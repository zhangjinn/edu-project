 ...
 * @returns {AxiosPromise}
 */
export function createChild({ remark, avatar, membershipCards, childName, relationshipList, gender, birthday, areaCode, address, qqNumber, wechatNumber, followerId, marketerId, category, statusId, sourceId, importanceAttrId, tagIdList }) {
  return request({
 ...
 * @returns {AxiosPromise}
 */
export function updateChild({ remark, membershipCards, childId, avatar, childName, relationshipList, gender, birthday, areaCode, address, qqNumber, wechatNumber, followerId, marketerId, category, statusId, sourceId, importanceAttrId, tagIdList }) {
  return request({
    url: `/newdaycare/child/${childId}`,
    method: 'put',
    data: {
 ...
 * @returns {AxiosPromise}
 */
export function createKindergarten({ sourceChildId, clazzId, isLeftBehindChildren, childName, bloodType, healthCondition, onceSick, foodAllergyInfo, drugAllergyInfo, isCompleteVaccination, isEatByYourself, imageList, remarks, nationality, certificateType, certificateNumber, currentAreaCode, currentAddress, householdRegisterAreaCode, birthday, gender, enrollmentTime, relationshipList, avatar }) {
  return request({
