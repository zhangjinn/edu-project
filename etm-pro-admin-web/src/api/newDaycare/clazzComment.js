 ...
 */
export function queryTc_reviews({ state, childName, courseName, startDate, endDate, pageNum, pageSize, paged, sort }) {
  return request({
 ...
 * @returns {AxiosPromise}
 */
export function queryCac_reviews({ state, childName, clazzName, dateSrt, pageNum, pageSize, paged, sort }) {
  return request({
