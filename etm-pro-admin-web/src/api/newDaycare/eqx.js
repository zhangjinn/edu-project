...
export function queryEqxResourceList({ editType, name, pageNo, pageSize }) {
  return request({
    url: `/newdaycare/eqx/resource/list`,
    method: 'get',
...
export function queryResourceInfo({ editType, id }) {
  return request({
    url: `/newdaycare/eqx/resource/info`,
    method: 'get',
    params: { editType, id }
  })
}
...
export function queryEqxStore({ editType }) {
  return request({
    url: `/newdaycare/eqx/resource/visit`,
    method: 'get',
    params: { editType }
  })
}
...
export function queryEqxEdit({ resourceId, editType }) {
  return request({
    url: `/newdaycare/eqx/resource/edit`,
    method: 'get',
...
export function removeEqxResource({ resourceId }) {
  return request({
    url: `/newdaycare/eqx/resource/${resourceId}`,
    method: 'delete'
  })
}
...
export function queryEqxResourcePreview({ resourceId, editType }) {
  return request({
    url: `/newdaycare/eqx/resource/preview`,
    method: 'get',
    params: { resourceId, editType }
  })
}
...
export function queryEqxH2ResourceDownload({ resourceId, code }) {
  return request({
    url: `/newdaycare/eqx/resource/download`,
    method: 'get',
...
export function queryEqxWinnerList({ id, pageNo, pageSize }) {
  return request({
    url: `/newdaycare/eqx/resource/rewardList`,
    method: 'get',
...
export function queryEqxResourceForm({ editType, id }) {
  return request({
    url: `/newdaycare/eqx/resource/form`,
    method: 'get',
    params: { editType, id }
  })
}
...
export function queryEqxIsPay() {
  return request({
    url: `/newdaycare/eqx/resource/isPay`,
    method: 'get'
  })
}
...
//   return request({
//     url: `/newdaycare/eqx/resource/rewardExcel`,
//     method: 'get',
//     params: { id, pageNo, pageSize }
//   })
// }
...
export async function queryRewardData({ id }) {
  return request({
    url: `/newdaycare/eqx/resource/rewardData`,
    method: 'get',
    params: { id }
  })
}
