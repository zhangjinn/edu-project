...
export function queryIllnessList() {
  return request({
    url: '/guardcare/leave_illness/list',
    method: 'get'
  })
}
...
export function updateIllnessItem({ illnessId, illnessName }) {
  return request({
    url: `/guardcare/leave_illness/${illnessId}`,
    method: 'put',
    data: { illnessName }
  })
}
...
export function sortIllnessItem(leaveIllnessList) {
  return request({
    url: '/guardcare/leave_illness/sort_index',
    method: 'put',
...
export function queryLeaveListByPage({ childName, gradeId, clazzId, startDate, endDate, status, pageNum, pageSize }) {
  return request({
    url: '/guardcare/leave_request/page',
    method: 'get',
...
export function queryLeaveLast({ startTIme, endTime }) {
  return request({
    url: '/guardcare/leave_request/length',
    method: 'get',
...
export function createAttendanceByCard(attendanceCardNumber) {
  return request({
    url: '/guardcare/attendance/attendance_by_card',
    method: 'post',
