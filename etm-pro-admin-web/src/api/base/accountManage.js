 ...
 * @returns {AxiosPromise}
 */
export function queryPaymentSetting() {
  return request({
    url: `/basic/payment/pay/setting`,
    method: 'get'
 ...
 * @returns {AxiosPromise}
 */
export function queryPaymentMerchantInfo() {
  return request({
    url: `/basic/payment/efps/pay_config/merchant/info`,
    method: 'get'
