 ...
 * @returns {AxiosPromise}
 */
export function createFollowSave({ customFields, followContent, followImg, nextFollowTime, customerId, followWay, customerSalesStage, bookExperienceTime, customerMark, customerImportantLevel }) {
  return request({
    url: `/customer/follow/v2`,
    method: 'post',
    data: { customFields, followContent, followImg, nextFollowTime, customerId, followWay, customerSalesStage, bookExperienceTime, customerMark, customerImportantLevel }
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function createFileImport({ batchCode, file }) {
  return request({
    url: `/customer/customer/v2/import`,
    method: 'post',
    params: { batchCode, file }
  })
}
