      ...
      <template v-if="depositData">
        <div>
          ...
          <etm-field-label
            ...
            type="left"
          >
            {{ depositData.childName }}
          </etm-field-label>
          <etm-field-label
            label="订金金额"
            type="left"
          >
            {{ depositData.money.toFixed(2) }}
          </etm-field-label>
          <etm-field-label
            label="支付方式"
            type="left"
          >
            {{ depositData.paymentName }}
          </etm-field-label>
          <etm-field-label
            label="收费日期"
            type="left"
          >
            {{ parseTime(depositData.dateCharge, '{y}-{m}-{d}') }}
          </etm-field-label>
          <etm-field-label
            label="订金状态"
            type="left"
          ...
          <etm-field-label
            ...
            type="left"
          >
            {{ depositData.createName }}
          </etm-field-label>
          <etm-field-label
            label="登记时间"
            type="left"
          >
            {{ crateTime(depositData.crateTime) }}
          </etm-field-label>
          <etm-field-label
            label="备注"
            type="left"
