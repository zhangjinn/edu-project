      ...
      <div class="popBox">
        ...
        >
          ...
          <el-form-item label="缴费日期">
            <el-date-picker
              v-model="chargeForm.paymentDate"
              type="datetime"
              :clearable="false"
            />
          </el-form-item>
        ...
        <div class="totalBox">
          已选<span>{{ chargeTable.length }}</span>人
        </div>
