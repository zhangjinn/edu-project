    ...
    >
      <etm-table-tool-bar slot="tool">
        ...
        >
          ...
          <el-button
            v-has="{authId: 'daycare.food.create'}"
            type="primary"
            @click="handleAdd"
          >
      ...
      >
        <template v-slot="scoped">
          <etm-text
            v-has="{authId: 'daycare.food.query'}"
            type="primary"
      ...
      >
        <template v-slot="scoped">
          <etm-text
            v-has="{authId: 'daycare.food.update'}"
            type="primary"
          ...
          <etm-text
            v-has="{authId: 'daycare.food.remove'}"
            type="danger"
    ...
    <etm-drawer :visible.sync="drawerVisible">
      <etm-layout-split line>
        ...
        <div class="drawerBody">
          <detail
            v-if="drawerVisible && drawerType==='detail' && foodId"
            :item-id="foodId"
          />
          <edit
