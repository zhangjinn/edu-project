          ...
          <div v-if="activeName === 'teach'">
            ...
            >
              ...
              <el-table-column
                ...
                label="总收入（元）"
                align="right"
                prop="teachDataVO.incomeAmount"
              />
              <el-table-column
                slot="right"
                label="新增签单数"
                prop="teachDataVO.newSigningQuantity"
              />
              <el-table-column
                slot="right"
                label="总会员（人）"
                prop="teachDataVO.childQuantity"
              />
              <el-table-column
                slot="right"
                label="意向学员（人）"
                prop="teachDataVO.intentionChildQuantity"
              />
            </etm-table-page>
          </div>
          <div v-else-if="activeName === 'care'">
            ...
            >
              ...
              <el-table-column
                ...
                label="总收入（元）"
                align="right"
                prop="careDataVO.incomeAmount"
              />
              <el-table-column
                slot="right"
                label="新增入托（人）"
                prop="careDataVO.newSigningChildQuantity"
              />
              <el-table-column
                slot="right"
                label="总入托（人）"
                prop="careDataVO.inBookChildQuantity"
              />
              <el-table-column
                slot="right"
                label="剩余托位（人）"
                prop="careDataVO.remainPosition"
              />
            </etm-table-page>
          </div>
        </div>
