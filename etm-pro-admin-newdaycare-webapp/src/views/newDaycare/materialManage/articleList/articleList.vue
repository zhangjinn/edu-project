    ...
    >
      <etm-table-tool-bar slot="tool">
        <div slot="right">
          <el-button
            slot="right"
            v-has="{authId: 'daycare.material.create'}"
            type="primary"
            @click="addArticle"
          >
            <i
      ...
      >
        <template v-slot="row">
          <etm-text
            v-has="{authId: 'daycare.material.update'}"
            type="primary"
          ...
          <etm-text
            v-has="{authId: 'daycare.material.remove'}"
            type="danger"
...
import edit from '@/views/newDaycare/materialManage/articleList/edit'
import detail from '@/views/newDaycare/materialManage/articleList/detail'
