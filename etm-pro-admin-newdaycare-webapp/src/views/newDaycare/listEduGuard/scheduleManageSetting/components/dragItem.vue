    ...
    >
      ...
      >
        ...
        <div class="greyWrap">
          ...
          <div
            v-if="noSlot.indexOf('top') === -1 && !item.currentTerm"
            :class="item.editable === false ? 'topWrap _noTop' : 'topWrap'"
            @click.stop="handleToTop(index)"
          >
            <slot
              name="top"
              :index="index"
          ...
          <div
            v-if="noSlot.indexOf('delete') === -1 && !item.currentTerm"
          ...
          <div
            v-if="noSlot.indexOf('handle') === -1 && !item.currentTerm"
