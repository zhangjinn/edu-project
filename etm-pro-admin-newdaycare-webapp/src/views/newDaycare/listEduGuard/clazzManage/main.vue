      ...
      <template slot="body">
        ...
        >
          <etm-table-tool-bar slot="tool">
            <el-button
              slot="right"
              v-has="{authId: 'guardcare.clazz.create'}"
              type="primary"
              @click="addGrade"
            >
          ...
          >
            <template v-slot="scoped">
              <etm-text
                v-if="!hasAuthOfBool('guardcare.clazz.query')"
                type="normal"
              >
                {{ scoped.row.name }}
              </etm-text>
          ...
          >
            <template v-slot="scoped">
              <etm-text
                v-has="{authId: 'guardcare.clazz.update'}"
                type="primary"
              ...
              <etm-text
                v-has="{authId: 'guardcare.clazz.remove'}"
                type="danger"
    ...
    >
      <etm-layout-split line>
        ...
        >
          ...
          >
            <el-button
              v-has="{authId: 'guardcare.clazz.query'}"
              plain
              size="mini"
              @click="cancelDrawer"
            >
        ...
        <div class="drawerBody">
          <detail
            v-if="drawerVisible && drawerType==='detail' && clazzId"
            :item-id="clazzId"
          />
          <edit
            v-if="drawerVisible && drawerType==='edit' && clazzId"
            ref="childDrawerForm"
            :item-id="clazzId"
          />
          <enter-child
            v-if="drawerVisible && clazzId"
            :item-id="clazzId"
            @refresh="refresh"
          />
        </div>
