<template>
  <div class="edit">
    ...
    >
      ...
      >
        <el-select
          v-model="form.featuredPrograms"
          placeholder="请选择特色课程"
          @change="changeFeaturedPrograms"
        >
          <el-option
      ...
      >
        <el-select
          ...
          filterable
          placeholder="请选择授课老师"
          @change="changeTeacher(form.headTeacher,'headTeacher')"
        >
          <el-option
      ...
      >
        <el-select
          ...
          filterable
          placeholder="请选择助教老师"
          @change="changeTeacher(form.teacher,'teacher')"
        >
          <el-option
            v-for="item in teacherOptions"
            :key="item.value"
    ...
    >
      <div class="popContent">
        <editChild
          v-if="popVisible"
          ref="childPopForm"
          :select-ids="form.childIds"
          :special-course-id="form.featuredPrograms"
        />
      </div>
    </etm-pop>
  </div>
...
// import { getRoom } from '@/api/newDaycare/listEduGuardCourseManage'
import { getCourseSpecial } from '@/api/newDaycare/listEduGuardCourseManage'
import { getScheduleItem, getScheduleTimeSetting, getRoom } from '@/api/newDaycare/listEduGuardScheduleManage'
  ...
  methods: {
    ...
    init () {
      ...
      getRoom(param).then((res) => {
        this.roomOptions = this.convertDataToOptions(res.data, 'roomName', 'roomId')
      })
