<template>
  <div class="detail">
    <ul>
      <li>
        <etm-field-label label="课程名称">
          {{ baseInfo.specialCourse }}
        </etm-field-label>
      </li>
      <li>
        <etm-field-label label="授课老师">
          {{ baseInfo.headTeacher }}
        </etm-field-label>
      </li>
      <li>
        <etm-field-label label="助教老师">
          {{ baseInfo.teacher }}
        </etm-field-label>
      </li>
      <li>
        <etm-field-label label="上课场地">
          {{ baseInfo.room }}
        </etm-field-label>
      </li>
      <li>
      ...
      <li class="scheduleWeeks">
        <etm-field-label label="上课日">
          {{ baseInfo.scheduleWeeks }}
        </etm-field-label>
      </li>
    </ul>
    <div>
