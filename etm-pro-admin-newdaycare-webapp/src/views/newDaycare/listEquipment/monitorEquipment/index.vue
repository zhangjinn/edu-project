<template>
      ...
      <etm-layout-split>
        <div slot="header">
          ...
          >
            ...
            <el-tab-pane
              v-if="hasAuth('newdaycare.monitorCare.queryBatch', 'tabs', 'name')"
              label="托育云视频服务"
            ...
            <el-tab-pane
              v-if="hasAuth('newdaycare.monitorGuard.queryBatch', 'tabs', 'name')"
              label="幼儿云视频服务"
              name="service"
            >
              <etm-tool-bar
              ...
              >
                <el-form-item label="幼儿姓名:">
                  <el-input
                    v-model.trim="filters.childName"
                    placeholder="请输入幼儿姓名"
                  />
                </el-form-item>
                ...
                <el-form-item label="家长姓名:">
                  <el-input
                    v-model.trim="filters.parentName"
                    placeholder="请输入家长姓名"
                  />
                </el-form-item>
            ...
            >
              ...
              >
                <template slot-scope="scoped">
                  <etm-text
                    v-show="name === 'service' && scoped.row.status !== 'UN_BUY'"
                    type="primary"
                    @click.stop="renew(scoped)"
                  >
                    续费
                  </etm-text>
                  <etm-text
                    v-show="name === 'service' && scoped.row.status !== 'UN_BUY'"
                    type="danger"
                    @click.stop="closeService(scoped)"
                  >
                    关闭服务
                  </etm-text>
                  <etm-text
                    v-show="name === 'service' && scoped.row.status === 'UN_BUY'"
                    type="primary"
                    @click.stop="activeOffline(scoped)"
                  >
                    线下开通
                  </etm-text>
                </template>
      ...
      >
        <etm-layout-split>
          ...
          >
            ...
            >
              <el-select
                v-model="drawerFormData.serviceId"
                placeholder="请选择套餐"
              ...
              >
                ...
                >
                  ...
                  <span
                    v-show="item.discountMoney !== null"
                    style=" color: #666;
  text-decoration: line-through;"
            ...
            >
              <el-select
                v-model="drawerFormData.paymentType"
                placeholder="请选择支付方式"
              >
                <el-option
...
export default {
  ...
  methods: {
    ...
    handleSetting () {
      this.$router.push({ name: 'videoEquipmentSetting' })
    },
    // 幼儿园部分
