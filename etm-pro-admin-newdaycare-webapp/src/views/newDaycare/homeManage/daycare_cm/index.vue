                ...
                >
                  ...
                  >
                    ...
                    <span
                      ref="labelEl"
                      class="label"
                    >（{{ $t('systemSetting.stepsTwoTips') }}）</span>
                  </el-tooltip>
                </div>
                <el-button
                  type="primary"
        ...
        <div class="carouselBox">
          ...
          >
            ...
            >
              <div class="innerBox">
                <span
                  class="closeIcon iconfont iconclose"
                  @click="closeCarousel"
                />
                <div class="count">
...
import { getClientUrl } from '@/api/newDaycare/daycare_cm'
