<template>
  ...
  display: flex;"
        ...
        <template slot="toolRight">
          <div class="btn">
            <el-button
              v-has="{authId: 'daycare.scheduleCourseCare.createBatch'}"
              type="primary"
            ...
            <el-button
              v-has="{authId: 'daycare.scheduleCourseCareWeek.copy'}"
              type="primary"
              @click="copyDayCourse"
            >
              复制周课表
        ...
        <template v-slot:cell="data">
          ...
          >
            <div v-if="course.courseManagementId">
              ...
              <div class="popTip">
                <span
                  v-has="{authId: 'daycare.scheduleCourseCare.query'}"
                  type="primary"
                  @click="doDetail(course)"
                >详情</span>
                <span
                  v-has="{authId: 'daycare.scheduleCourseCare.copy'}"
                  type="primary"
                  @click="doCopy(course)"
                >复制</span>
                <span
                  v-has="{authId: 'daycare.scheduleCourseCare.remove'}"
                  type="primary"
