<template>
  <div class="schedule-wrap">
    ...
    >
      ...
      <template slot="toolRight">
        <div class="button-group">
          <el-button
            type="primary"
            @click.stop="batchScheduling"
          >
            <i class="el-icon-plus" />&nbsp;&nbsp;批量添加
          </el-button>
          <el-button
            type="primary"
            @click="copy = true"
      ...
      <template v-slot:cell="data">
        ...
        <template v-else>
          ...
          >
            ...
            <div class="itemTools">
              <div @click.stop="addRemark(data)">
                备注
              </div>
              <div @click.stop="showDetail(data)">
                详情
              </div>
              <div @click.stop="deleteSched(data)">
                删除
              </div>
            </div>
          </div>
    ...
    <add-schedule
      ref="addSchedule"
      :props="addScheduleProp"
      @update="init"
    />
    <remark-schedule
      ref="remarkSchedule"
      :props="remarkScheduleProp"
      @update="init"
    />
    <detail-schedule
      ref="detailSchedule"
      :props="detailScheduleProp"
      @update="init"
    />
    <batch-add
      ref="batchAdd"
      :props="batchScheduleProp"
      @update="init"
    />
    ...
    >
      ...
      >
        <el-form-item label="选择班级">
          <el-select
            v-model="copyForm.targetClazzIdList"
            multiple
          >
            <el-option
