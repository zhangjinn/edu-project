    ...
    >
      <div class="ingredient-box">
        ...
        >
          <el-col :span="colSpan">
            <el-form-item
              :prop="'ingredientsList.'+ index +'.ingredientsTypeId'"
              :rules="rule.ingredientsTypeId"
            >
              <el-select
              ...
              >
                <el-option
                  v-for="(list, i) in ingredientsTypeOptions"
                  :key="i"
                  :label="list.label"
                  :value="list.value"
                />
          ...
          <el-col :span="colSpan">
            <el-form-item
              :prop="'ingredientsList.'+ index +'.ingredientsId'"
              :rules="rule.ingredientsId"
            >
              <el-select
              ...
              >
                <el-option
                  v-for="(list, i) in item.ingredientsOptions"
                  :key="i"
                  :label="list.label"
                  :value="list.value"
                />
          ...
          <el-col :span="colSpan">
            <el-form-item
              :prop="'ingredientsList.'+ index +'.ingredientsWeight'"
              :rules="rule.ingredientsWeight"
            >
              <el-input-number
                v-model="item.ingredientsWeight"
                :min="0"
                :max="10000"
              />
            </el-form-item>
