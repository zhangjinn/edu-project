  ...
  <div class="index-wrap">
    <etm-main-body>
      <div class="overViewBox">
        ...
        <div class="cardBox">
          <div
            v-for="(total, index) in totalData"
            :key="index"
            class="cardList"
          >
            <div class="list">
              <div class="listBox">
                ...
                <div class="data">
                  <div class="count">
                    ￥{{ formatMoney(total.totalIncomeAmount) }}
                  </div>
                  <div class="label">
                    {{
            ...
            <div class="list">
              <div class="listBox">
                ...
                <div class="data">
                  <div class="count">
                    ￥{{ formatMoney(total.totalExpendAmount) }}
                  </div>
                  <div class="label">
                    {{
                      total.businessType === 'CARE' ? '托育' : total.businessType === 'TEACH' ? '早教' : total.businessType === 'GUARD' ? '幼儿园' : '总'
      ...
      <div class="chartBox">
        <div class="chart">
          <div class="chartTop">
            ...
            <el-select
              v-model="guardAreaValue"
              @change="getGuardChartData"
            >
              <el-option
                v-for="(area, index) in areaList"
                :key="index"
          ...
          <bar-chart
            v-if="guardChartData.xData && guardChartData.xData.length"
            :chart-data="guardChartData"
          />
          <etm-empty v-else />
        </div>
        <div class="chart">
          <div class="chartTop">
            ...
            <el-select
              v-model="careAreaValue"
              @change="getCareChartData"
            >
              <el-option
                v-for="(area, index) in areaList"
                :key="index"
          ...
          <bar-chart
            v-if="careChartData.xData && careChartData.xData.length"
            :chart-data="careChartData"
          />
          <etm-empty v-else />
        </div>
        <div class="chart">
          ...
          <line-chart
            v-if="incomeChartData.xData && incomeChartData.xData.length"
        ...
        <div class="chart">
          ...
          <line-chart
            v-if="studentChartData.xData && studentChartData.xData.length"
            :chart-data="studentChartData"
          />
          <etm-empty v-else />
        </div>
      </div>
