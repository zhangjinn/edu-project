...
import { queryOldOrganization } from '@/api/newDaycare/childDataHead'
...
export default {
  ...
  computed: {
    columns () {
      const common = [
        { label: '应出勤人数', prop: 'shouldArriveNumber', width: '200', sortable: true, sortBy: 'shouldArriveNumber' },
        { label: '实际出勤人数', prop: 'arrivedNumber', width: '200', sortable: true, sortBy: 'arrivedNumber' },
        { label: '请假人数', prop: 'requestForLeaveNumber', width: '200', sortable: true, sortBy: 'requestForLeaveNumber' },
        { label: '缺勤人数', prop: 'absenceNumber', width: '200', sortable: true, sortBy: 'absenceNumber' },
        { label: '出勤率', prop: 'rateOfAttendance_p', width: '200', sortable: true, sortBy: 'rateOfAttendance_p' }
      ]
      ...
      if (this.activeName === 'child') {
        return [
          ...
          { label: '应出勤天数', prop: 'shouldArriveNumber', width: '200', sortable: true, sortBy: 'shouldArriveNumber' },
          { label: '实际出勤天数', prop: 'arrivedNumber', width: '200', sortable: true, sortBy: 'arrivedNumber' },
          { label: '请假次数', prop: 'requestForLeaveNumber', width: '200', sortable: true, sortBy: 'requestForLeaveNumber' },
          { label: '缺勤次数', prop: 'absenceNumber', width: '200', sortable: true, sortBy: 'absenceNumber' },
          { label: '出勤率', prop: 'rateOfAttendance', width: '200', sortable: true, sortBy: 'rateOfAttendance' }
        ]
      }
      return []
    },
