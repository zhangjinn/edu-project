            ...
            <template slot-scope="scope">
              ...
              <span v-else>
                <span v-if="column.prop==='state'">
                  <etm-status :type="scope.row.enable ? 'active' : 'inactive'">
...
const columnsList = {
  earlyCourse: [
    ...
    },
    {
      ...
      prop: 'totalCapacity',
      sortable: true,
      sortBy: 'totalCapacity'
    },
    {
      label: '正式学位',
      prop: 'formalCapacity',
      sortable: true,
      sortBy: 'formalCapacity'
    },
    {
      label: '试听学位',
      prop: 'experienceCapacity',
      sortable: true,
      sortBy: 'experienceCapacity'
    },
    {
      label: '消课课时',
      prop: 'courseTime',
  ...
  earlySet: [
    ...
    },
    {
      ...
      prop: 'buyLessonTotal',
      sortable: true,
      sortBy: 'buyLessonTotal'
    },
    {
      label: '赠送课时',
      prop: 'handselLessonTotal',
      sortable: true,
      sortBy: 'handselLessonTotal'
    },
    {
      label: '总价',
      prop: 'totalPrice',
