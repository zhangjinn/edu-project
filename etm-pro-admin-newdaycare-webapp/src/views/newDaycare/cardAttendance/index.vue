        ...
        <etm-layout-split>
          <div>
            ...
            <div v-if="showPop">
              ...
              >
                <el-col :span="8">
                  <etm-field-label label="考勤状态">
                    {{ stu.attendanceStatus }}
                  </etm-field-label>
                  <etm-field-label label="上课时间">
                    {{ starTime }}
                  </etm-field-label>
                  <etm-field-label label="接送人">
                    {{ parent }}
                  </etm-field-label>
                </el-col>
                <el-col :span="8">
                  <etm-field-label label="剩余课时">
                    {{ stu.lastLesson }}
                  </etm-field-label>
                  <etm-field-label label="上课教室">
                    {{ stu.roomName }}
                  </etm-field-label>
                </el-col>
                <el-col :span="8">
