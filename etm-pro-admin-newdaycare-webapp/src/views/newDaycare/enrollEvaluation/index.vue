        ...
        <div class="main">
          ...
          <div class="item">
            ...
            <div class="footer">
              ...
              <div
                class="footer-item border"
                @click="showSharePanel($refs.babyPost,shareBabyPost,babyLink)"
              >
                <span class="iconfont iconshare" />
                <div>分享</div>
              </div>
          ...
          <div class="item">
            ...
            <div class="footer">
              ...
              <div
                class="footer-item border"
                @click="showSharePanel($refs.childPost,shareChildPost,childLink)"
              >
                <span class="iconfont iconshare" />
                <div>分享</div>
              </div>
