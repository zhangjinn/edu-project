const titleConfig = [
  ...
  { Choice: '.ql-list[value="ordered"]', title: '有序' },
  { Choice: '.ql-list[value="bullet"]', title: '无序' },
  { Choice: '.ql-direction', title: '文本方向' },
  { Choice: '.ql-header[value="1"]', title: '一号标题' },
  { Choice: '.ql-header[value="2"]', title: '二号标题' },
...
export function quillEditorTip () {
