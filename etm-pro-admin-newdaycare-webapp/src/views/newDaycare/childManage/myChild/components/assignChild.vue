<template>
  <div class="assignChild-wrap">
    ...
    >
      ...
      >
        <el-input
          v-model="assignForm.selectedNum"
          disabled
        />
      </el-form-item>
      <el-form-item
  ...
  margin-bottom: 24px;"
        >
          <el-select
            v-model="assignForm.followId"
            filterable
            @change="handleSelectFollower"
          >
            <el-option
              v-for="(follow) of followers"
              :key="follow.value"
              :label="follow.label"
              :value="follow.value"
            />
