  ...
  <div class="batchImport-wrap">
    ...
    >
      ...
      <el-form-item label="名单来源">
        <el-input
          v-model="batchImportData.source"
          placeholder="请输入名单来源"
        />
      </el-form-item>
      <el-form-item label="模板">
        ...
        <!--        DEAL-->
        <el-button
          v-if="category === 'UNSOLD'"
          type="dashed"
          @click="downloadTemplate('UNSOLD_IMPORT_TEMPLATE')"
        >
          下载模板
        </el-button>
        <template v-else>
          <el-button
            type="dashed"
            @click="downloadTemplate('TA_COMPLETED_IMPORT_TEMPLATE')"
          >
            下载早教学员模板
          </el-button>
          <el-button
            type="dashed"
            @click="downloadTemplate('CA_COMPLETED_IMPORT_TEMPLATE')"
          >
            下载托育学员模板
          </el-button>
        </template>
