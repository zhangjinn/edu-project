    ...
    <etm-main-body>
      <etm-layout-split>
                ...
                <div slot="right">
                  ...
                  >
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <el-dropdown-item command="batchAssignManage">
                        分配批次管理
                      </el-dropdown-item>
                      <el-dropdown-item command="batchImportManage">
                        导入批次管理
                      </el-dropdown-item>
                    </el-dropdown-menu>
                  </el-dropdown>
                ...
                <template v-slot="{row}">
                  ...
                  <el-dropdown :hide-on-click="false">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <el-dropdown-item
                        v-has="{authId : 'newdaycare.earnestMoney.create'}"
                        @click.native="handleBooking(row)"
                      >
                        预收订金
                      </el-dropdown-item>
                      <el-dropdown-item
                        v-has="{authId : 'newdaycare.contractTeach.create'}"
                        @click.native="handleSignUp({...row, signUpType : 'CARE', new : 'y'})"
                      >
                        早教签约
                      </el-dropdown-item>
                      <el-dropdown-item
                        v-has="{authId : 'newdaycare.contractCare.create'}"
                        @click.native="handleSignUp({...row, signUpType : 'EARNEST', new : 'y'})"
                      >
                        托育签约
                      </el-dropdown-item>
                      <el-dropdown-item
                ...
                <template v-slot="{row}">
                  ...
                  <el-dropdown :hide-on-click="false">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      <!--                      <el-dropdown-item-->
                      <!--                        v-has="{authId : 'newdaycare.auditionTeach.create'}"-->
                      <!--                        @click.native="showCourse(row, 'TEACH', 'app')"-->
                      <!--                      >-->
                      <!--                        早教约课-->
                      <!--                      </el-dropdown-item>-->
                      ...
                      <el-dropdown-item
                        v-has="{authId : 'newdaycare.contractTeach.create'}"
                        @click.native="handleSignUp({...row, signUpType : 'CARE', new : 'n'})"
                      >
                        早教续约
                      </el-dropdown-item>
                      <el-dropdown-item
                        v-has="{authId : 'newdaycare.contractCare.create'}"
                        @click.native="handleSignUp({...row, signUpType : 'EARNEST', new : 'n'})"
                      >
                        托育续约
                      </el-dropdown-item>
                      <el-dropdown-item
        ...
        <div class="addChildren">
          ...
          >
            <add-child-form
              v-if="addChildVisible"
              ref="addChildForm"
              :child-type="currentTab"
            />
          </etm-pop>
        </div>
...
import Collection from '@/views/newDaycare/contract/components/collection'
let uploadLoading
