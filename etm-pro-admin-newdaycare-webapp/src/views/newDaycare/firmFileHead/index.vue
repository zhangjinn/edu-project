<template>
  <div class="index-wrap">
    <etm-main-body>
      <etm-layout-split>
        <div v-if="!showEdit">
          <etm-field-label label="园所名称">
            {{ form.organizationName }}
          </etm-field-label>
          <etm-field-label label="园所面积">
            {{ form.gardenArea||0 }}平方米
          </etm-field-label>
          <etm-field-label label="场地年租金">
            {{ form.annualRent||0 }}
          </etm-field-label>
          <etm-field-label label="设为幼儿园">
            {{ form.kindergarten?'是':'否' }}
          </etm-field-label>
          <etm-field-label
            v-if="form.kindergarten"
            label="幼儿园满园人数"
          >
            {{ form.gfullGarden }}
          </etm-field-label>
          <etm-field-label label="设为托育园">
            {{ form.nurserySchool?'是':'否' }}
          </etm-field-label>
          <etm-field-label
            v-if="form.nurserySchool"
            label="托育园满园人数"
          >
            {{ form.careFullGarden }}
          </etm-field-label>
