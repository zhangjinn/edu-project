<template>
  <div class="customerDetail">
    <div class="followUpAvatar">
      <div class="avatar">
        <el-avatar
          v-if="customerDetailLists.avatar"
          :size="72"
          :src="customerDetailLists.avatar"
        />
        <span
          v-else
          style=" color: #c1c4cc;
  ...
  width: 72px;"
    ...
    <div
      v-if="customerDetailLists.customFields.length>0"
    ...
    >
      ...
      <ul class="contactInfo">
        <li
          v-for="(item,index) in customerDetailLists.contact"
          :key="index"
        >
          <div
            v-if="item.customFields.length>=3"
      ...
      <ul>
        <li
          v-for="(item,index) in customerDetailLists.customFields"
          :key="index"
        >
          <etm-field-label
            type="left"
