        ...
        >
          ...
          >
            <template slot-scope="scoped">
              <el-button
                type="text"
                @click="showChild(scoped.row.customerId)"
              >
      ...
      <etm-layout-split>
        ...
        <template v-else>
          ...
          <etm-field-label
            ...
            type="left"
          >
            {{ customerDetail.parentName }}
          </etm-field-label>
          <etm-field-label
            label="联系人电话"
            type="left"
          >
            {{ customerDetail.parentPhone }}
          </etm-field-label>
          <etm-field-label
            label="性别"
            type="left"
          >
            {{ customerDetail.gender === 'MALE' ? '男' : '女' }}
          </etm-field-label>
          <etm-field-label
            label="生日"
            type="left"
          >
            {{ customerDetail.birthday | parseTime }}
          </etm-field-label>
          <etm-field-label
            label="学员来源"
            type="left"
          >
            {{ customerDetail.sourcesName }}
          </etm-field-label>
        </template>
      </etm-layout-split>
    </etm-drawer>
