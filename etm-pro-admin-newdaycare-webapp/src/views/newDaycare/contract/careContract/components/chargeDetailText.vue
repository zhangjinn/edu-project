    ...
    <div v-if="detailData.contractType != 'TRANSFER_COURSE'">
      ...
      <el-row class="row">
        ...
        <el-col
          ...
          :span="8"
        >
          <etm-field-label label="入托日期">
            {{ detailData.validBeginTime }}
          </etm-field-label>
        </el-col>
        <el-col
          v-if="!print"
        ...
        <el-col
          ...
          :span="8"
        >
          <etm-field-label label="合同顺延时长">
            {{ detailData.extensionDay }}天
          </etm-field-label>
        </el-col>
        <el-col :span="8">
