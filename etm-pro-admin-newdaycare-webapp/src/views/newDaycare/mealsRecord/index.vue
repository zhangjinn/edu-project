  ...
  <div class="index-wrap">
    <etm-main-body>
      <etm-layout-split>
        <div slot="header">
          <etm-tabs
            v-model="tabsActivateName"
            :setting="hasAuthOfBool('daycare.mealsRecord.setting')"
            @setting="setting"
          >
            <el-tab-pane
              label="报餐统计"
          ...
          >
            ...
            >
              <template slot-scope="{row}">
                <etm-text @click="mealsDetail(row)">
                  {{ showTime(row.date) }}
                </etm-text>
              </template>
            </el-table-column>
      ...
      columns: [
        {
          ...
          sortable: true,
          sortBy: 'orderCourseAmount'
        },
        {
          label: '学员普通餐数量',
          prop: 'childNormalMealAmount',
          sortable: true,
          sortBy: 'childNormalMealAmount'
        },
        {
          label: '特殊学员餐数量',
          prop: 'childSpecMealAmount',
          sortable: true,
          sortBy: 'childSpecMealAmount'
        },
        {
          label: '员工餐数量',
          prop: 'employeeMealAmount',
          sortable: true,
          sortBy: 'employeeMealAmount'
        },
        {
          label: '总报餐数',
          prop: 'totalMealAmount',
          sortable: true,
          sortBy: 'totalMealAmount'
        },
        {
          label: '学生餐/员工餐',
