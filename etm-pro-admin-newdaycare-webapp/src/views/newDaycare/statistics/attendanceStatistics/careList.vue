    ...
    >
      <etm-table-tool-bar slot="tool">
        <div slot="right">
          <el-button
            plain
            @click="exportTableToExcel({id: 'xlsxTable', name:'托育考勤统计'})"
          >
            导出Excel
          </el-button>
        </div>
  ...
  data () {
    return {
      columns: [
        ...
        { label: '应出勤（天）', prop: 'shouldNum', sortable: true, sortBy: 'shouldNum' },
        { label: '已出勤（天）', prop: 'actuallyNum', sortable: true, sortBy: 'actuallyNum' },
        { label: '缺勤（天）', prop: 'absentNum', sortable: true, sortBy: 'absentNum' },
        { label: '请假（天）', prop: 'askNum', sortable: true, sortBy: 'askNum' },
        { label: '出勤率', prop: 'probability', sortable: true, sortBy: 'probability' }
      ],
      tableData: []
    }
  },
