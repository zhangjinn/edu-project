    ...
    return {
      ...
      colOption: [
        ...
        },
        {
          ...
          label: '学员总数（人）', prop: 'childTotal', sortable: true, sortBy: 'childTotal'
        }, {
          label: '跟进学员数（人）', prop: 'childFollowUp', sortable: true, sortBy: 'childFollowUp'
        }, {
          label: '跟进率',
          prop: 'childFollowUpRate',
          ...
          sortable: true,
          sortBy: 'childFollowUpRate'
        }, {
          label: '到访学员数（人）', prop: 'childVisit', sortable: true, sortBy: 'childVisit'
        }, {
          label: '到访率',
          prop: 'childVisitRate',
          formatter: (row, column, val, index) => {
          ...
          sortable: true,
          sortBy: 'childVisitRate'
        }, {
          label: '试听学员数（人）', prop: 'auditionChild', sortable: true, sortBy: 'auditionChild'
        }, {
          label: '试听率',
          prop: 'auditionRate',
          formatter: (row, column, val, index) => {
          ...
          label: '签约学员数（人）', prop: 'signedChild', sortable: true, sortBy: 'signedChild'
        }, {
          label: '签约率',
          prop: 'childSigningRate',
          formatter: (row, column, val, index) => {
          ...
          sortable: true,
          sortBy: 'childSigningRate'
        }, {
          label: '签约单数', prop: 'signedOdd', sortable: true, sortBy: 'signedOdd'
        }
      ]
    }
  },
