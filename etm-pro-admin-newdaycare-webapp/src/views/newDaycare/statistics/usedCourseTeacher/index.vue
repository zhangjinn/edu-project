      ...
      colOption: [
        {
          ...
          label: '消课课时', prop: 'consumeLesson', sortable: true, sortBy: 'consumeLesson'
        }, {
          label: '消课课时小计', prop: 'consumeLessonByTeacherType', sortable: true, sortBy: 'consumeLessonByTeacherType'
        }, {
          label: '消课总课时', prop: 'consumeLessonByTeacher', sortable: true, sortBy: 'consumeLessonByTeacher'
        }, {
          label: '消课金额（元）', prop: 'consumeAmount', align: 'right', sortable: true, sortBy: 'consumeAmount'
        }, {
          label: '消课金额小计（元）', prop: 'consumeAmountByTeacherType', align: 'right', sortable: true, sortBy: 'consumeAmountByTeacherType'
        }, {
          label: '消课总金额（元）', prop: 'consumeAmountByTeacher', align: 'right', sortable: true, sortBy: 'consumeAmountByTeacher'
        }
      ]
    }
  },
