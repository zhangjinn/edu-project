<template>
  <div class="importPop-wrap">
    ...
    <div class="mainText">
      ...
      <div class="text">
        适用首次加入班级的幼儿填写，可下载二维码，打印张贴到报名处或转发给家长扫码填写。
      </div>
    </div>
    <div class="qrCode">
      <div
    ...
    <div class="mainText">
      ...
      <div class="text">
        Excel表格录入幼儿信息，下载幼儿信息导入模板，按要求录入信息，再导入系统中。
      </div>
    </div>
    <div class="download">
      <div class="tips">
        1.下载导入幼儿信息模板，按要求填写信息
      </div>
      <div class="btnBox">
        <el-button
          plain
...
import { queryChildRegistrationUrl } from '@/api/newDaycare/childManageGuard'
...
export default {
  ...
  methods: {
    ...
    getTemplate () {
      const params = {
        template: 'IMPORT_GUARD_IN_CHILD'
      }
