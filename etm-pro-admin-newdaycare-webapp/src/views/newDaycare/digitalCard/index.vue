              ...
              <div class="footer-card-item">
                <div class="footer-item">
                  <div class="img-box">
                    ...
                    <span
                      v-if="selectStyle === 1"
                      class="selectIcon iconfont iconxuanzhong1"
                    />
                  </div>
                  <!--                  <span>简洁风</span>-->
                </div>
            ...
            >
              <el-col :span="24">
                <etm-form type="dialog">
                  ...
                  >
                    <el-input
                      v-model="userInfo.businessCardName"
                      placeholder="请输入姓名"
                    />
                  </el-form-item>
                  ...
                  <el-form-item label="详细地址">
                    <el-input
                      v-model="userInfo.organizationDetailedAddress"
                      maxlength="28"
                    />
                  </el-form-item>
                ...
                <div class="btn-footer">
                  <el-button
                    type="primary"
                    @click="updateCard(userInfo.businessCardId)"
                  >
                    更新名片
                  </el-button>
                  <el-button
