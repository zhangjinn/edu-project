          ...
          >
            ...
            >
              ...
              <div>
                <img
                  v-if="item.rate===1"
                  src="../../../../assets/images/img-tbl-select.png"
                  alt=""
                >
                <img
                  v-else
                  src="../../../../assets/images/icon-tbl-normal.png"
                  alt=""
                >
              </div>
              <div>
                <img
                  v-if="item.rate===2"
                  src="../../../../assets/images/img-yjb-select.png"
                  alt=""
                >
                <img
                  v-else
                  src="../../../../assets/images/icon-yjb-normal.png"
                  alt=""
                >
              </div>
              <div>
                <img
                  v-if="item.rate===3"
                  src="../../../../assets/images/img-yjy-select.png"
                  alt=""
                >
                <img
                  v-else
                  src="../../../../assets/images/icon-yjy-normal.png"
                  alt=""
                >
              </div>
            </li>
