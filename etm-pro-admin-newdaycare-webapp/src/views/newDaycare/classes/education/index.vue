  ...
  <div class="education-wrap">
    ...
    >
      <etm-table-tool-bar slot="tool">
        <div slot="right">
          <el-button
            v-has="{authId : 'daycare.clazzTeach.create'}"
            type="primary"
            @click="ClassOpen"
          >
      ...
      >
        <template slot-scope="scoped">
          <etm-status :type="scoped.row.enable ? 'active' : 'inactive' ">
      ...
      >
        <template slot-scope="scoped">
          ...
          <etm-text
            v-has="{authId : 'daycare.clazzTeach.remove'}"
            type="danger"
    ...
    >
      ...
      >
        <el-form-item
          :required="true"
          :rules="formValidate.nullValueRule(true, '请输入班级姓名', ['change'])"
          label="班级名称"
          prop="name"
        >
          <el-input
