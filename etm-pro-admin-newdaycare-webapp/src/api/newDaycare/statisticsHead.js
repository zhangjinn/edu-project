 ...
 * @returns {AxiosPromise}
 */
export function queryCourseTermListByOrganizationId ({ organizationId }) {
  return request({
    url: '/newdaycare/guard/educational/course/term/by_organization_id',
    method: 'get',
 ...
 * @returns {AxiosPromise}
 */
export function querySemesterList ({ organizationId }) {
  return request({
    url: '/newdaycare/guard/educational/course/term/by_organization_id',
    method: 'get',
    params: { organizationId }
