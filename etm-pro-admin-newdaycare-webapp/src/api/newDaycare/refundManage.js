 ...
 * @returns {AxiosPromise}
 */
export function queryRefundList ({ childName, clazzId, status, pageNum, pageSize, paged, childStatus }) {
  return request({
    url: '/newdaycare/guard/refund/page',
    method: 'get',
    params: { childName, clazzId, status, pageNum, pageSize, paged, childStatus }
  })
}
